...
- [List zones](https://techdocs.akamai.com/edge-dns/reference/get-zones.md): All zones that the current user has access to manage. The response is [paginated](/reference/use-pagination).
...
- [Get a version's record sets](https://techdocs.akamai.com/edge-dns/reference/get-zone-versions-recordsets.md): Lists all record sets for this zone. It works only for `PRIMARY` and `SECONDARY` zones. This operation [paginates](/reference/use-pagination).
...
- [Get a version's master zone file](https://techdocs.akamai.com/edge-dns/reference/get-zones-zone-versions-uuid-zone-file.md): Downloads the record sets from a prior zone version in [master zone file](/reference/get-zone-versions-uuid) format. This applies to primary and secondary zones.
...
- [Show changes](https://techdocs.akamai.com/edge-dns/reference/get-changelists-zone-diff.md): Show [differences](/reference/get-zone-versions-diff) between this change list and its base version.
