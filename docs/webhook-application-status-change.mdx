---
title: "Webhook - Application Status Change"
---
...
- [Application Statuses](/docs/customer-verification-application-statuses)
- [Integration Guide](/docs/customer-verification-integration-guide)
- [Webhook - Customer Created](/docs/webhook-customer-created)
