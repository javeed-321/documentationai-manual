...
<Video src="/files/Revamped-Trust-Vault-Dashboard-with-Interactive-Data.mp4" render-type="video" controls="true" />
...
<Video src="/files/Corrective-Action-Approval-Workflow-1.mp4" render-type="video" controls="true" />
...
<Video src="/files/Risk-Workflow-Updates.mp4" render-type="video" controls="true" />
