---
title: "February 2026"
description: "Scrut's February 2026 release features ISO/IEC 27701:2025, AI-powered policy mapping, editable policy versions, Trust Portal subscriptions, and more."
---
...
<Callout kind="info">
  Learn more: [Supported Frameworks](/docs/frameworks-controls/frameworks/framework-overview#iso-277012025)
</Callout>
...
<Callout kind="info">
  Learn more: [Map Controls to Policies using Scrut Teammates](/docs/policy/ai-powered-features-1/ai-suggested-policy-control-mapping)
</Callout>
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163273763-f78cl16sbhi-Policy-gaps.png?fm=auto&auto=compress%2Cformat" alt="" />

<Callout kind="info">
  Learn more: [AI-Detected Policy Gaps](/docs/policy/ai-powered-features-1/ai-detected-policy-gaps)
</Callout>
...
<Callout kind="info">
  Learn more: [Upload a Policy Document](/docs/policy/working-with-policies/uploading-policy#2-upload-policy-document)
</Callout>
...
<Callout kind="info">
  Learn more: [Manage Policy Versions](/docs/policy/managing-organizing-policies/editing-a-policy-version)
</Callout>
...
<Callout kind="info">
  Learn more: [Detect Evidence Gaps with Scrut Teammates](/docs/continuous-compliance/evidence-tasks/ai-powered-features-2/automated-evidence-checker)
</Callout>
...
<Callout kind="info">
  Learn more: [Enable Trust Portal Subscriptions](/docs/trust-management/trust-vault/settings-1/turn-on-subscriptions-to-trust-portal-updates)
</Callout>
...
<Callout kind="info">
  Learn more: [Mitigation Task Approval Workflow](/docs/risk-management/mitigation-task/mitigation-task-approval-workflow)
</Callout>
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788162549602-pr4y31p7d1-My-Tasks-tab-1.png?fm=auto&auto=compress%2Cformat" alt="" />

<Callout kind="info">
  Learn more: [My Tasks Tab](/docs/lighthouse-documentation/task-center/my-tasks-task-center)
</Callout>

## Other Updates

- **Mandatory vendor questionnaire attachments:** [Mark attachments mandatory](/docs/vendor-management/creating-vendor-questionnaire-template-1/adding-vendor-questionnaire-manually#step-2-add-questions-to-the-template) for questions, so vendors cannot submit without uploads such as policies, certifications, or reports.
- **Questionnaire smart import field selection:** During [Questionnaire Import](/docs/vendor-management/creating-vendor-questionnaire-template-1/bulk-importing-template), explicitly map which columns are questions and which are answers (including multi-field selections).
- **Import your risk register without adhering to a strict template:** Previously, teams had to download the risk import template, reshape their register to match, and upload again. Scrut has simplified the [risk register import](/docs/risk-management/overview-5/adding-a-new-risk#3-import-risks-in-bulk) into three easy steps: upload your file, map column headers to Scrut fields, and preview the mapped data before saving.
...
- **Integration-synced vendors:** [Integration-synced vendors](/docs/vendor-management/managing-your-vendors/added-via-integrations) can be archived but not deleted, which prevents them from reappearing after sync.
- **Editable evidence templates:** You can now [edit evidence templates](/docs/continuous-compliance/evidence-tasks/upload-attachments-to-an-evidence-task/using-evidence-templates#editing-the-sample-template) directly within Scrut to match your specific organizational requirements.
- **Notification Center:** View all your pending tasks and other notifications directly in the [Notifications Center](/docs/lighthouse-documentation/onboarding-setup/notification-center) instead of browsing module-by-module.
- **Cloudflare multi-zone:** [Cloudflare integration](/docs/integrations/web-security-cdn/integrating-cloudflare) now supports multi-zone selection; monitors collect evidence per selected zone, and tests run per zone with failing zones shown as separate resource rows.
