---
title: "Commercial Variable Recurring Payments"
---
...
If you are building for **Me-to-Me** payments -- where the same person or business entity owns both accounts -- Sweeping VRP is the correct product. See the [Variable Recurring Payments](/docs/variable-recurring-payments) section for details.

## Guides

Use these pages to build your integration:

- [Commercial cVRP Overview](/docs/commercial-vrp-overview)
- [Getting started with cVRP](/docs/getting-started-with-cvrp)
- [Creating a cVRP consent](/docs/creating-a-cvrp-consent)
- [Initiate a cVRP payment](/docs/creating-a-cvrp-payment)
