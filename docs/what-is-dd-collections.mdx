...
description: "With the Direct Debit Collection API"
---
...
Once this has been done you can start to experiment in Sandbox with the Direct Debit collection API, which is detailed [here](/reference/getmandates).
