...
<Image src="https://files.readme.io/c37bae7-7fda530-App_extensions_-_footer_of_the_app_panel_-_Pipedrive.png" alt="1202" caption="Global actions in the JSON panel" />
...
<Image src="https://files.readme.io/c1d5525-669a43e-App_extensions_-_object_actions_app_panel_-_Pipedrive.png" alt="1202" caption="Object actions" />
...
<Image src="https://files.readme.io/d8badf2-8e50fac-App_extensions_-_field_actions_app_panel_-_Pipedrive.png" alt="1202" caption="Field actions" />
...
<Image src="https://files.readme.io/d10ac6a-App_extensions_-_global_actions_-_Pipedrive.png" alt="962" caption="Global actions at the bottom left of the app panel" />
...
<Image src="https://files.readme.io/e9a8885-App_extensions_-_JSON_panel_-_main_action_dropdown_menus.png" alt="1200" caption="The main action fields with a dropdown menu" />
...
<div className="row" style="box-sizing: border-box; display: flow-root">
  <div className="column" style="box-sizing: border-box; float: left; width: 50%; padding: 0.5px">
    <figure style="box-sizing: border-box">
      <span className="lightbox" role="dialog" tabindex="0" style="box-sizing: border-box"><span className="lightbox-inner" style="box-sizing: border-box"><img src="https://files.readme.io/91464a3-App_extensions_-_main_link_action_for_global_actions.png" title="Click to close..." className="lightbox-img" width="80%" align="" caption="" height="auto" alt="Ensure your action&#x27;s Location is the same as your JSON panel" loading="lazy" style="box-sizing: border-box" /></span></span>
      <figcaption style="box-sizing: border-box">
        <p style="box-sizing: border-box">Ensure your action's Location is the same as your JSON panel</p>
      </figcaption>
    </figure>
  </div>
  <div className="column" style="box-sizing: border-box; float: left; width: 50%; padding: 0.5px">
    <figure style="box-sizing: border-box">
      <span className="lightbox" role="dialog" tabindex="0" style="box-sizing: border-box"><span className="lightbox-inner" style="box-sizing: border-box"><img src="https://files.readme.io/6b12e04-App_extensions_-_JSON_panel_main_action_selection.png" title="Click to close..." className="lightbox-img" width="80%" align="" caption="" height="auto" alt="The action will then appear in the main action dropdown menu in the JSON panel&#x27;s form" loading="lazy" style="box-sizing: border-box" /></span></span>
      <figcaption style="box-sizing: border-box">
        <p style="box-sizing: border-box">The action will then appear in the main action dropdown menu in the JSON panel's form</p>
      </figcaption>
    </figure>
  </div>
</div>
...
<Image src="https://files.readme.io/519db72-App_extensions_-_JSON_panel_-_link_and_object_action.png" alt="Adding a link and object action" caption=" " />
...
| Panel action target    | The location where the link will be displayed:Object – the action is universal for every object in your panelField – the action is specific to the selected field |
...
| API endpoint (required)        | All API requests related to this action will be sent to this URL                                                                                                        |
| JWT secret                     | If left empty, `client secret` will be used by default                                                                                                                  |
| JSON data structure (required) | The JSON schema for your JSON modal                                                                                                                                     |
| Panel action target            | The location where the JSON modal will be displayed:Object – the action is universal for every object in your panelField – the action is specific to the selected field |
