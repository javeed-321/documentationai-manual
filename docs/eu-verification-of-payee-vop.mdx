---
title: "EU Verification of Payee (VoP)"
description: "Information about the VoP service being launched by EU PSPs in October 2025"
---
...
<Image src="https://files.readme.io/470b2af5b66beed7dcf4f45214914450e408751747876328d68e37b9b4156992-image.png" alt="Image" caption=" " />
...
<Image src="https://files.readme.io/cafb5858d5fcdf9ab3b8ab5d22057db79f3bce4e8b4d88d3e46f9ad124551a28-image.png" alt="Image" caption=" " />
...
<Image src="https://files.readme.io/e04c464c7dbc68722e63bde0a3684c43434a4cdb101a7ae9756be614f42524cc-image.png" alt="Image" caption=" " />
...
Ensure you are registered with the Modulr Sandbox; see notes on sandbox test data in [Sending verification of payee checks](/docs/sending-vop-check-requests)

---

## VoP Request (Sending VoP requests to other PSPs)

A new [API endpoint](/reference/createoutboundvop) is available in line with the industry timeline that enables a Partner or Client to perform a check on a beneficiary ahead of making payment. Please see [Sending verification of payee checks](/docs/sending-vop-check-requests) for details of the API usage & sandbox test cases.
