...
3. Click the **Add Asset** button, then select **Manually** from the dropdown menu.
   ...
   <Image src="/images/Add-Asset-button.png" alt="" />
...
5. Click **Save** to add the asset to your inventory.
   ...
   <Image src="/images/Add-Asset-Manually-modal.png" alt="" />
...
4. Upload the asset file in CSV or XLSX format. Make sure to include the required fields **Resource ID** and **Resource Name**.
   ...
   <Image src="/images/Screenshot-2025-12-09-at-13.36.07.png" alt="" />
...
5. Map your fields: Scrut will display your file's columns and ask you to map them to Scrut's standard fields. For each column in your file:
   ...
   - If a field from your file doesn't match any Scrut field, select **Not Available**
     ...
     <Image src="/images/Screenshot-2025-12-09-at-13.36.28.png" alt="" />

6. Map additional fields: Continue mapping all relevant fields.

   <Image src="/images/Screenshot-2025-12-09-at-13.36.54-1.png" alt="" />

7. Review your mappings and click **Import Asset** to begin the import process.

   <Image src="/images/Screenshot-2025-12-09-at-13.37.09.png" alt="" />
...
9. **Download Error File** to get a report of the issues. Review it to identify problems (e.g., missing required fields, invalid data formats, duplicate IDs, etc.)
   ...
   <Image src="/images/image-1765269297654.png" alt="" />
