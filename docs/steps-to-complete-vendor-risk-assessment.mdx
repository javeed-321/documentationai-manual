...
metaDescription: "Understand the steps to complete a vendor risk assessment in Scrut."
---
...
Next Reads: [Sending Questionnaires to Vendors](/docs/sending-vendor-questionnaire) | [Vendor Risk Assessment with Scrut Teammates](/docs/ai-enhanced-vendor-assessment)
...
Note: Scrut sends questionnaires only to vendors with an assigned POC. [Add a POC to the vendor profile](/docs/editing-poc-details) before sending.
...
Next Reads: [Evaluating Vendor Questionnaire Responses](/docs/evaluating-vendor-questionnaire) | [Creating Risks from Vendor Questionnaires](/docs/risk-creation-from-vendor-questionnaires)
...
Next Read: [Exporting the Vendor Risk Assessment Report](/docs/exporting-vendor-risk-assessment-report)
...
Next Read: [Vendor Reassessment](/docs/vendor-reassessment)
