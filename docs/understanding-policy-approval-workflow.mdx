...
metaDescription: "Understand how policy approval works in Scrut."
---
...
<ExpandableGroup>
  <Expandable title="What happens if I turn the toggle off after enabling it?" default-open="false">
    Existing approvers stay assigned to their policies, but Scrut stops enforcing sign-off before publishing.
  </Expandable>

  <Expandable title="How do policy statuses change with the approval workflow?" default-open="false">
    See [how policy statuses are impacted by the approval workflow](/docs/policy-statuses#how-policy-approval-workflow-impacts-policy-status).
  </Expandable>
</ExpandableGroup>
