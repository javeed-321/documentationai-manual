...
metaDescription: "Learn how Scrut's Penetration Testing as a Service (PTaaS) delivers continuous, audit-ready security testing through CREST-accredited processes, certified"
---
...
**Note:** Scan timing is managed by Scrut's Security Expert team according to your [Program Calendar](/docs/understand-your-ptaas-program-calendar). You can view your Program Calendar, including your Full Pentest and Release Scan schedule, on each target's Target Detail page. You cannot trigger scans manually.
