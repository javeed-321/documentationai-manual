...
metaDescription: "List of all the supported asset types in Scrut's Asset Management module."
---
...
The asset management module collates all the different devices tracked and monitored via Mobile Device Management (MDM) tools and [Scrut Agent](/docs/scrut-agent-walkthrough#what-is-scrut-agent), including smartphones, tablets, laptops, desktops, and other mobile endpoints.
