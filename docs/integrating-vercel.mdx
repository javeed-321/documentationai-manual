...
metaDescription: "Learn how to connect your organization's Vercel account with Scrut."
---
...
4. Set the **Scope** to Full Account. If you want Scrut to collect data from a specific project only, select that project from the Scope dropdown instead.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788171210932-tquk67tl4al-Screenshot-2025-09-16-at-11-58-39-AM.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />

5. Set an expiration date for the token.

6. Click **Create**.

   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788171187755-gnulhyok9r6-Screenshot-2025-09-15-at-20-33-30.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
7. Copy the token value and store it securely. You will need it in the next step.
   ...
   **Note:** The token is displayed only once. Copy it before closing this screen. Vercel cannot retrieve it again.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788171189078-ai1fs6kcvq-Screenshot-2025-09-15-at-20-34-27.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
4. Find the Vercel tile and click **Integrate**.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788171191793-iv2kcoqaiv9-Screenshot-2025-09-15-at-20-35-32.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />

5. Paste the API token you copied in Step 1 into the API Token field.

6. Click **Submit**.

   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788171190381-dmpjyfq8h37-Screenshot-2025-09-15-at-20-35-00.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
<ExpandableGroup>
  <Expandable title="Can I limit the integration to a specific Vercel project?" default-open="false">
  ...
  <Expandable title="What data does Scrut collect from Vercel?" default-open="false">
  ...
  <Expandable title="Does the integration support bidirectional sync?" default-open="false">
