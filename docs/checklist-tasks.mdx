...
metaDescription: "Understand what checklists are in Scrut, the different task types, and categories in an employee checklist."
---
...
Employees can view and complete these tasks through Scrut’s dedicated [employee portal](/docs/employee-portal-overview). When you assign a checklist to an employee group, all group members will receive an automated email from Scrut notifying them of the assigned tasks. They can find the employee portal login details in the email.
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788162021200-rbvjxy2ufq-Employee-Portal.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
<Tabs>
  <Tab title="Ongoing Tasks">
    ...
    <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163599885-fx5m64sgqiq-Screenshot-2025-06-05-at-18-00-07.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
    ...
    **How to complete**: Employees log in to the Scrut [employee portal](/docs/employee-portal-overview) and acknowledge policies on their dashboard.
    ...
    **Note:**
    ...
    - Policies marked with a blue diamond are Scrut-suggested. Scrut recommends adding these to the checklist. Click the **Include Suggested Policies** button to add all Scrut-suggested policies to this checklist.
      ...
      <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788161910926-d3148zbqhja-Blue-Diamond.png?fm=auto&auto=compress%2Cformat" alt="" width="16" height="16" caption=" " />

    - Turn on the **Show Selected Policies** toggle to view all the policies you’ve selected.

    <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788164609450-9awd7vz61fo-Screenshot-2025-11-04-at-19-03-25.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />

    ### 2: Install Monitoring Agent

    <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163827928-5m6grd6rdaw-Screenshot-2025-07-16-at-14-32-08.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
    ...
    **How to complete**:
    ...
    - **Using Scrut Agent**: Personnel download and install [Scrut Agent](/docs/scrut-agent-walkthrough) on their device.
    - **Using MDM**: You can also manage employee device compliance by [integrating your MDM solution](/docs/integrations-overview#7-mobile-device-management-mdm-tools) with Scrut. In this case, personnel must have the selected MDM tool on their device.

    #### 2.1 Install Password Manager

    <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163829227-2qga64kdw86-Screenshot-2025-07-16-at-14-33-15.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
    ...
    **How to complete:** Personnel must install the approved password manager on their devices to complete this task.
    ...
    <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163830579-aw70ksm9w1n-Screenshot-2025-07-16-at-14-34-02.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
    ...
    **How to complete:**
    ...
    <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788161868951-fvgiyiw5f5m-Adding-Software-in-Checklist.gif?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
    ...
    **How to complete:** Personnel must install all applications designated as "required software" to complete this task.
    ...
    <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163601126-rzusxez4nic-Screenshot-2025-06-05-at-18-10-51.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />

    **What is it:** Tracks if employees have completed the required security awareness training campaigns.

    **How to complete**: Employees log in to the Scrut [employee portal](/docs/employee-portal-overview), complete the assigned training campaigns and finish associated quizzes. The training completion status syncs directly into the Employees module.

    ### 4: Background Checks

    <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163602388-74q2rj9722h-Screenshot-2025-06-05-at-18-21-53.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
    ...
    **How to complete**: [Integrate your background verification tool](/docs/integrations-overview#6-background-check) with Scrut and import results into Scrut.
  </Tab>

  <Tab title="Offboarding Tasks">
    ### 1: Access Removal of Monitored Applications

    <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163603694-zaqxhzyd75-Screenshot-2025-06-05-at-18-22-23.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
    ...
    **How to complete**: Scrut automatically detects account deactivation for applications that you have integrated with the platform.
    ...
    <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163604987-495tuleb8si-Screenshot-2025-06-05-at-18-22-49.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
