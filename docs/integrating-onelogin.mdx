...
metaDescription: "Learn how to integrate OneLogin SSO with Scrut."
---
...
- Manage All scope selected when creating API credentials.
  ...
  - Refer to the [FAQs below](/docs/integrating-onelogin#faqs) for details on why Scrut requires the Manage All permissions.
...
9. In the **Redirect URIs** field in your OneLogin portal (under Applications → your OIDC app → Configuration), add the following URI: https://scrut.eu.auth0.com/login/callback
   ...
   **Important:** This redirect URI is required for the integration to work with Scrut's Auth0 configuration. The integration will fail without it. To know more, [see here](/docs/scrut-authentication-system-migration).
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788162574285-38jjvdopi54-OneLogin-Redirect-URL-3.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
3. Click **Integrate**. The OneLogin integration page opens.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788165660955-a9c6wh49kcb-Screenshot-2026-05-12-at-11-10-09.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
5. Click **Submit**.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788165662313-dzvx1t3bhv-Screenshot-2026-05-12-at-11-10-30.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
