---
title: "Open Banking V4 API transition"
description: "Information on new fields & ASPSP transition dates"
---
...
| V3 code                                | Mapped V4 code                                                              |
| :------------------------------------- | :-------------------------------------------------------------------------- |
| BILLPAYMENT("BillPayment")             | • BILLINGGOODSANDSERVICESINADVANCE • ("BillingGoodsAndServicesInAdvance")   |
| ECOMMERCEGOODS("EcommerceGoods")       | • ECOMMERCEMERCHANTINITIATEDPAYMENT • ("EcommerceMerchantInitiatedPayment") |
| ECOMMERCESERVICES("EcommerceServices") | • ECOMMERCEMERCHANTINITIATEDPAYMENT • ("EcommerceMerchantInitiatedPayment") |
| PARTYTOPARTY("PartyToParty")           | TRANSFERTOSELF("TransferToSelf")                                            |
| OTHER("Other")                         | TRANSFERTOTHRIDPARTY("TransferToThirdParty")                                |

### New v4 codes

| v4 code                                                               | Description                 |
| :-------------------------------------------------------------------- | :-------------------------- |
| BILLINGGOODSANDSERVICESINARREARS ("BillingGoodsAndServicesInArrears") | Post-paid billing scenarios |
| • FACETOFACEPOINTOFSALE • ("FaceToFacePointOfSale")                   | In-person payments          |
