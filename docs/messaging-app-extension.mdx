...
<Image src="https://files.readme.io/f8bcb92-app_inbox_2.png" alt="1752" caption="Messaging inbox - active conversation details" />
...
<Image src="https://files.readme.io/d8b963d-app_frames.png" alt="1503" caption="Messaging inbox with messages from Facebook and WhatsApp" />
...
<Image src="https://files.readme.io/c11a100-inbox_channels.png" alt="460" caption="Selection of messaging apps and their channels" />
...
<Image src="https://files.readme.io/0d92899-settings_1.png" alt="1752" caption="Messaging app in Pipedrive Settings" />
...
| `provider_channel_id` | string      | Required                       | • A unique `provider_channel_id` string that represents the channel ID. Pipedrive will use this ID in requests to ask your integration for data about the channel. • See [template for messaging manifest](/docs/implementing-messaging-app-extension#template-for-messaging-manifest) for an example of how the `providerChannelId` is used. |
...
```json title="Sample response for POST /Channels"
{
   "success":true,
   "data":{
...
<Image src="https://files.readme.io/3ac46d8-Installation_flow_-_messaging_app_extension.png" alt="818" caption="Installation flow of app with messaging app extension" />
...
<Image src="https://files.readme.io/c4a1be9-Facebook_Messenger_app_-_Pipedrive_-_Messaging_app_extension.png" alt="1330" caption="The user has the option to share the app company-wide." />
...
<Image src="https://files.readme.io/d6542a9-setting_sharing_1.png" alt="911" caption="The messaging app can be shared in between account users" />
