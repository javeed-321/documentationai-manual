...
## updatedAt: 2026-06-09T15:05:02.000Z
...
[Public apps](https://pipedrive.readme.io/docs/marketplace-registering-the-app) are for providing a public offering of your integration to any Pipedrive user. Here are some key characteristics of public apps:
...
[Private apps](https://pipedrive.readme.io/docs/marketplace-registering-a-private-app) are for providing your integration to selected Pipedrive users/companies. Here are some key characteristics of private apps:
...
**Don’t abuse the API; use webhooks** Instead of polling or constantly asking for data, consider using [webhooks for apps](https://pipedrive.readme.io/docs/webhooks-for-apps). This way, you won’t hit the [rate limit](https://pipedrive.readme.io/docs/core-api-concepts-rate-limiting) and will have data coming to you instead.
...
**Manage and update your app** After submitting and approving your app, you can update it when changes are required or if you no longer wish to have it public. Learn more about updating and managing your app [here](https://pipedrive.readme.io/docs/marketplace-updating-the-existing-app).
