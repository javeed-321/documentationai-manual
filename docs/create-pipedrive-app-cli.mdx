...
If you chose app extensions, expose the Vite dev server through an HTTPS tunnel — for example [ngrok](https://ngrok.com/) or [Cloudflare Tunnel](https://www.cloudflare.com/products/tunnel/) — and paste that URL into your app in the [Developer Hub](/docs/developer-hub). The generated frontend already handles SDK initialization, resizing, theme switching, and extension-specific actions.
