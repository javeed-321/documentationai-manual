...
To obtain the report details, which you will need to download the specific report, you will first need to make a call to [See Card Reports](/reference/searchreports) which will provide you a list of the reports that are available to download along with the respective ID's
...
Once you have the report ID's required you then need to make a call to [Get Card Reports](/reference/retrievereport) using the ID's provided to obtain the individual reports, these will be returned back in .csv format.
