---
title: "May 2026"
metaDescription: "Read Scrut release notes for May 2026: DPDPA 2023 compliance, recurring audit cloning, vendor assessment timelines, Google Drive policy import, and other"
---
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788166206277-8lyrzm4m5s-Vendor-Assessment-Timeline.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />

<Callout kind="info">
  Learn more: [Track vendor assessment progress](/docs/vendor-assessment-progress-timeline)
</Callout>
...
<Callout kind="info">
  Learn more: [Using Scrut Teammates to autofill questionnaires](/docs/quick-start-guide-questionnaire-autofill)
</Callout>
...
<Callout kind="info">
  Learn more: [Cloning an audit](/docs/clone-an-audit)
</Callout>
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788161982763-nip6z31zkfs-Customize-Trust-Portal-Layout-1.gif?fm=auto&auto=compress%2Cformat" alt="" caption=" " />

<Callout kind="info">
  Learn more: [Customize the display order of your Trust Portal sections](/docs/customize-the-display-order-of-your-trust-portal)
</Callout>
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788165709381-xv41gomynls-Screenshot-2026-05-20-at-14-32-25-1.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
- Short-lived cloud resources are automatically ignored in the [asset registry](/docs/adding-assets#automatically-populated-asset-data-from-integrations) to reduce ephemeral clutter.
- [Custom fields are available](/docs/custom-fields-vulnerabilities)[for vulnerability findings](/docs/custom-fields-vulnerabilities) and resources to support local triage metadata.
- Automated tests can be [linked or unlinked to evidence tasks](/docs/evidence-automation-workflow) when mappings need correction.
...
- Access reviews support [bulk assignment](/docs/lifecycle-of-an-access-review#assign-account-identity) of non-personnel or external contractors.
- [Organization name](/docs/configure-organization-info) accepts common legal punctuation, including dots, commas, apostrophes, ampersands, parentheses, slashes, hyphens, and underscores.
- The [aggregated audit log](/docs/audit-logs-audit-center) in the audit center captures relevant activity across findings, requests, and corrective actions, while module-specific logs record module-level activity.
