...
metaDescription: "Learn what each Scrut policy status means. This article explains the policy lifecycle, the actions required at each stage, and how policy approval affects"
---
...
The Needs Review status indicates that the policy needs review and republishing to ensure ongoing compliance with evolving organizational rules and policies. Policies move from Published to Needs Review based on the configured [recurrence cycle](/docs/settings-a-policy-review-cycle).
