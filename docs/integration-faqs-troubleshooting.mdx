...
metaDescription: "Find answers to all your common Scrut integration queries."
---
...
<ExpandableGroup>
  ...
  <Expandable title="I have multiple subscriptions to the same cloud provider; how should I integrate them?" default-open="false">
    ...
    Refer to the [integration guides](/docs/integrations-overview#4-cloud-providers) for step-by-step instructions.
  </Expandable>
