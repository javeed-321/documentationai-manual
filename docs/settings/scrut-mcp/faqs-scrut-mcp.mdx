...
<ExpandableGroup>
  <Expandable title="Which AI tools can I connect to Scrut MCP?" default-open="true">
  ...
  <Expandable title="Which roles can use Scrut MCP?" default-open="true">
  ...
  <Expandable title="What happens if my Scrut role changes after I’ve connected Scrut MCP?" default-open="true">
  ...
  <Expandable title="Does Scrut MCP give my AI tool access to everything in Scrut?" default-open="true">
  ...
  <Expandable title="What happens if my Scrut account is deactivated?" default-open="true">
  ...
  <Expandable title="Are there limits on how many people in my org can connect through Scrut MCP at the same time?" default-open="true">
  ...
  <Expandable title="Is there a logout timeframe for Scrut MCP connections?" default-open="true">
  ...
  <Expandable title="Can I connect Scrut MCP to multiple AI tools at the same time?" default-open="true">
  ...
  <Expandable title="Can Scrut MCP change the status, owner, or assignment of an item?" default-open="true">
  ...
  <Expandable title="Will Scrut MCP work with locally hosted models like Llama?" default-open="true">
  ...
  <Expandable title="Can Scrut MCP read the full text of my policies and evidence documents?" default-open="true">
  ...
  <Expandable title="Can Scrut MCP delete or overwrite anything in my compliance program?" default-open="true">
  ...
  <Expandable title="Do I still need to review what Scrut MCP produces?" default-open="true">
  ...
  <Expandable title="Are there rate limits on Scrut MCP requests?" default-open="true">
    No rate limits are enforced today, and you don't need to space out your prompts.
  </Expandable>

  <Expandable title="Does Scrut MCP need access to my cloud environment or codebase?" default-open="true">
  ...
  <Expandable title="Does Scrut MCP replace Scrut?" default-open="true">
  ...
  <Expandable title="Is Scrut MCP available on all plans?" default-open="true">
    Yes. It is available for all plans (Foundation, Growth, and Scale)
  </Expandable>

  <Expandable title="Is Scrut MCP self-serve, or does Scrut need to enable it for our organization?" default-open="true">
    You can do it yourself. For step-by-step instructions, see here.
  </Expandable>

  <Expandable title="Can I switch between workspaces without reconnecting Scrut MCP?" default-open="true">
  ...
  <Expandable title="Does Scrut MCP support multi-entity filtering?" default-open="true">
