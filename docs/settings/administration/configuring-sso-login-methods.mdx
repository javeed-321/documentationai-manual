...
<ExpandableGroup>
  <Expandable title="Why can’t I see the Google Workspace / Microsoft Entra (Azure AD) toggles under Enterprise SSO?" default-open="true">
  ...
  <Expandable title="An external user (such as an auditor or contractor) can’t see the OTP login option. How do they log in?" default-open="true">
