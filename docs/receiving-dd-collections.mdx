---
title: "Receiving DD Collections"
---
...
<Image src="https://files.readme.io/3eb956c-DD_Outbound_Collection_flow.PNG" alt="DD Outbound Collection flow" caption=" " />
...
4. Modulr will treat collections that failed to debit or rejected debit as unpaid and change their status to Rejected. Modulr allows Partners to reject payment using the [Reject Collection](/reference/rejectcollection).\
...
<Image src="https://files.readme.io/b2a4ca0-image.png" alt="Image" caption=" " />

## API and Webhooks

Utilise the following APIs to manage Direct Debits\
**[Reject](/reference/rejectcollection)**– reject a Direct Debit collection or confirm that the next debit attempt should be skipped.

The collection processing notifications are sent using the existing Notification Service

- **[Webhook - Direct Debit, Incoming Collection](/docs/webhook-direct-debit-incoming-collection)** Notification informs Partner that debit will be attempted.
- **[Webhook - Direct Debit, Unpaid Collection](/docs/webhook-direct-debit-unpaid-collection)** Notification informs Partner that their nominated account will be debited.
- **[Webhook - Direct Debit, Return Funds](/docs/webhook-direct-debit-return-funds)** Notification informs Partner that funds associated with unpaid collections have be credited.
- **[Webhook - Outbound Payments](/docs/payout-webhook)** and **[Webhook - Inbound Payments](/docs/payin-webhook)** notify when an account is debited or credited – these notifications apply to all payment types.

<Image src="https://files.readme.io/8bd388b-Capture.PNG" alt="Capture" caption=" " />
