...
<ExpandableGroup>
  <Expandable title="Is the cloned policy linked to the source policy after creation?" default-open="true">
  ...
  <Expandable title="Why clone a policy?" default-open="true">
  ...
  <Expandable title="What happens if I clone a policy that has an unresolved policy variable?" default-open="true">
