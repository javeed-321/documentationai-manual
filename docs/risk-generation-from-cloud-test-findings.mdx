...
metaDescription: "Learn how to create a risk from a test finding."
---
...
In such cases, creating a risk directly from the test finding ensures that the finding is formally documented in your organization’s [risk register](/docs/understanding-risk-register), and you can manage it appropriately from the [risk management module](/docs/risk-trend-graph). In this article, we explain how to create a risk from a cloud test finding.
...
4. Select **Create Risk**.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788164791452-mkgb5wbdge-Screenshot-2025-11-27-at-14-37-03.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
7. Click **Save**. The test creation details are captured in the audit logs.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788164792849-i3sn9upxq9-Screenshot-2025-11-27-at-14-38-32.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />

8. Scroll to the **Risk** tab in the test finding page to view the risk details.

   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788164794248-btnia3c1i7o-Screenshot-2025-11-27-at-14-39-22.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
9. Clicking on the risk details takes you directly to the Risk Register. The risk's **Source Type** is set to “Test,” and **Source** is set to the test name.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788164795573-6ds82rqe80k-Screenshot-2025-11-27-at-14-40-47.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
