...
- Use the [**Risk Discovery**](/docs/adding-a-new-risk#1-add-risks-from-the-risk-discovery-tab) tab: Browse a curated table of common risks across organizations. Select any risks that apply to your organization and add them to your risk register in one go.
- [**Import in bulk**](/docs/adding-a-new-risk#3-import-risks-in-bulk)**:** Upload risks from a spreadsheet or export from another tool using an XLSX or CSV file. Use this when migrating an existing risk register or adding multiple risks at once.
- [**Add manually**](/docs/adding-a-new-risk#2-add-a-risk-manually)**:** Create risks one by one by entering details directly in Scrut. Use this for individual, ad hoc risks that fall outside your existing data sources.
- [**Create from other modules**](/docs/adding-a-new-risk#4-create-risks-from-scrut-modules): You can also create risks directly from other Scrut modules.
...
1. Open the risk.
2. Add the [Inherent Risk details](/docs/editing-risk-score#edit-inherent-risk-score), including the likelihood, impact, and risk score.
