...
_Collecting 10% commission automatically from each Modulr Customer account into one Modulr account, which then gets transferred daily to an external account._
