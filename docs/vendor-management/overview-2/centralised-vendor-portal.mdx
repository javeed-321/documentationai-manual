...
2. Enter the email you use to sign in to Scrut. Alternatively, log in with your Microsoft or Google account.
   ...
   <Image src="/images/Screenshot-2026-07-06-at-20.22.11.png" alt="" />

3. Complete the authentication, and you will land on the Dashboard.

   <Image src="/images/Vendor-Portal-Dashboard.png" alt="" />
...
3. The **Customer** filter helps you to quickly find questionnaires from a specific customer.
   ...
   <Image src="/images/Questionnaires-Tab.png" alt="" />
...
8. Click **Submit Questionnaire** once you've completed all required fields.
   ...
   <Image src="/images/Screenshot-2026-07-06-at-20.41.37.png" alt="" />
...
1. The **Mitigation Tasks** tab shows tasks your customer has assigned to you, typically requesting additional information or updated documents.
   ...
   <Image src="/images/Screenshot-2026-07-06-at-20.48.55.png" alt="" />

2. Click a task to open it.

3. Review the request and upload the correct files.

   <Image src="/images/Screenshot-2026-07-06-at-20.51.01.png" alt="" />
...
1. Navigate to the **Settings** tab.
   ...
   <Image src="/images/Screenshot-2026-07-06-at-20.53.33.png" alt="" />
...
<ExpandableGroup>
  <Expandable title="Can I view questionnaires sent by all my customers in the vendor portal?" default-open="true">
    ...
    <Image src="/images/image-ULZSA8CQ.png" alt="" />
