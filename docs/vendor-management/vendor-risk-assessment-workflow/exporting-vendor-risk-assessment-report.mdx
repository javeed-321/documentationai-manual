...
2. Click on the vendor for whom you want to export the report.
   ...
   <Image src="/images/Screenshot-2025-10-23-at-20.14.38.png" alt="" />

3. Go to the **Questionnaires** tab and click the questionnaire you want to export.

   <Image src="/images/Screenshot-2025-10-23-at-20.15.04.png" alt="" />
...
4. Click **Complete Assessment** if you haven’t done it already. See here for [step-by-step instructions on evaluating vendor responses and completing vendor assessment](/docs/vendor-management/vendor-risk-assessment-workflow/evaluating-vendor-questionnaire).
   ...
   <Image src="/images/Screenshot-2025-10-23-at-20.12.59-2.png" alt="" />
...
5. (Optional) Click **Add Assessment Summary.** Use this field to summarize your observations or add any additional notes identified during the vendor assessment.
   ...
   **Note:** You can edit the assessment summary at any time by clicking the edit icon next to it.
   ...
   <Image src="/images/Screenshot-2025-10-23-at-20.13.28.png" alt="" />

6. Click **Export** and select your preferred file format.

   <Image src="/images/Screenshot-2025-10-23-at-20.18.20.png" alt="" />

7. Choose whether to **include the comments** you’ve added while evaluating the questionnaire in the export.

   <Image src="/images/Screenshot-2025-10-23-at-20.18.48.png" alt="" />

8. Scrut will generate the report and email it to you.

   <Image src="/images/Screenshot-2025-10-23-at-20.18.57.png" alt="" />
...
2. Scroll to the **Vendor Risk Assessment** tile, and click the **Download** button.
   ...
   <Image src="/images/Screenshot-2025-10-23-at-20.24.04.png" alt="" />
...
5. Choose whether to **include comments in the report**.
   ...
   <Image src="/images/Screenshot-2025-10-23-at-20.24.36.png" alt="" />

6. Scrut will generate the report and email it to you.

   <Image src="/images/Screenshot-2025-10-23-at-20.26.51.png" alt="" />
...
<Image src="/images/Screenshot-2025-10-23-at-20.31.05.png" alt="" />
...
<ExpandableGroup>
  ...
  <Expandable title="Can I edit the assessment summary?" default-open="true">
    ...
    <Image src="/images/Screenshot-2025-10-23-at-20.50.11.png" alt="" />
  </Expandable>
</ExpandableGroup>
