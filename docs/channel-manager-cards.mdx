---
title: "Channel Manager - Cards"
---

## Creating Cards

When creating a card use endpoint [POST/channel-managers/accounts/\{aid}/cards](/reference/channelmanagercreatecard) and supply the following information as mandatory for creating cards for OTA’s:
...
[POST/channel-managers/cards/\{id}](/reference/channelmanagerupdatecard)
...
[PATCH/channel-managers/cards/\{id}](/reference/channelmanagerupdatecard_1)
...
<Callout kind="info">
  **Blocking / Unblocking Cards**
  ...
  [Block Cards](/reference/blockcard)

  [Unblock Cards](/reference/unblockcard)
</Callout>
...
When calling [GET/channel-managers/cards](/reference/channelmanagergetcards) you have a list of parameters that you are able to search by, these are:
...
If however, you are just looking to see the specific state a card is in use [POST/channel-managers/enquiry](/reference/channelmanagercardenquiry) and it will return all current details on the card.
