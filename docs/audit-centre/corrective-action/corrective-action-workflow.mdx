...
<ExpandableGroup>
  <Expandable title="What are corrective action statuses?" default-open="false">
  ...
  <Expandable title="What are the role permissions required for corrective actions?" default-open="false">
    **Admin**
  ...
  <Expandable title="Who is the approver for a corrective action?" default-open="false">
