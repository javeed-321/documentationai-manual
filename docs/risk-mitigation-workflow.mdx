...
metaDescription: "Understand the recommended workflow for risk mitigation tasks in Scrut."
---
...
- [Manually from the Risk Register](/docs/add-a-mitigation-task) (or)
- During the [risk assessment process](/docs/risk-assessment-workflow#step-4-mitigation-task-optional), after you select a treatment strategy.
...
See: [Upload an Attachment to a Mitigation Task](/docs/uploading-a-mitigation-task-document)

<Callout kind="alert">
  **Heads Up!**

  Steps 3, 4, and 5 are applicable only when the [risk mitigation task approval workflow is turned on](/docs/mitigation-task-approval-workflow#how-to-enable-the-mitigation-task-approval-workflow).
</Callout>
...
See: [Mitigation Task Approval Workflow](/docs/mitigation-task-approval-workflow)
