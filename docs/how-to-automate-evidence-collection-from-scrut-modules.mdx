...
metaDescription: "Learn how to use the Scrut Monitor to automate evidence collection from Scrut's internal modules."
---

The [Scrut Monitor](/docs/scrut-monitor) is a powerful tool designed to download audit-ready evidence from connected third-party applications at scheduled intervals automatically. It then attaches the downloads to Evidence Tasks, reducing the time and effort required for manually collecting and uploading evidence into Scrut.
...
- **Automated Internal Evidence Generation:** Scrut Monitor can automatically collect compliance reports from Scrut’s native modules, including:
  ...
  - [Risk → Risk Register](/docs/understanding-risk-register)
  - [Vendors](/docs/steps-to-complete-vendor-risk-assessment)
  - [People → Employees](/docs/step-by-step-tutorial-for-employee-module)
  - [Asset Management](/docs/asset-management-overview)
  - [Audit Center](/docs/understanding-an-audit-project)
...
Captures the risks available in your risk register at the time of report generation. The report mirrors the data you would get by clicking the [Export button on the Risk Register page](/docs/exporting-risk-register). It includes all active risks with their current status, ratings, and associated metadata.
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163925186-frnz4x2609v-Screenshot-2025-07-23-at-21-19-35.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />

### Step 2: Configure Scrut Monitor Workflow

1. On the Evidence detail page, click the **Upload Attachment** button.

   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788164454665-v2rvbl72xpd-Screenshot-2025-10-15-at-12-08-34.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />

2. Navigate to the **Scrut Monitor** tab, and click the **Configure** button next to the Scrut application.

   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163926516-t4q6v3sg5v-Screenshot-2025-07-23-at-21-21-30.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
4. Select the **Auto-publish evidence task** checkbox if you want to auto-publish the evidence task.
   ...
   **Note:** If left unselected, the task status will change to draft whenever the Scrut Monitor attaches new evidence, and you’ll need to publish it manually. Leave it unchecked if you want to review the evidence before publishing.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788163927919-9cxfanlux0r-Screenshot-2025-07-23-at-22-25-40.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
<ExpandableGroup>
  <Expandable title="Which Evidence Tasks can be automated using Scrut Internal Monitor?" default-open="false">
    Here’s a list of evidence tasks that can be automated by [following the steps mentioned above](/docs/how-to-automate-evidence-collection-from-scrut-modules#how-to-use-scrut-monitor-to-automate-internal-evidence-collection):
