...
metaDescription: "Quick start guide for using the cloud module in Scrut with a step-by-step workflow."
---
...
Sign in to Scrut, and navigate to **Integrations → Cloud Provider** to integrate Scrut with your cloud provider. See here for [step-by-step instructions to connect with your cloud provider](/docs/integrations-overview#4-cloud-providers).
...
Navigate to the Cloud dashboard to see test statuses. Take action on failing tests with code fixes or AI-powered remediation guidance. See here for [step-by-step instructions on working on a test finding](/docs/how-to-fix-failing-tests).
