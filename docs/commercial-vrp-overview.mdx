...
cVRP is a **Me-to-Them** payment type, meaning the payer and the recipient are different people or organisations. If you are building for **Me-to-Me** payments -- where the same person or entity owns both accounts -- see [Sweeping VRP](/docs/variable-recurring-payments) instead.
