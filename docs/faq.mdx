...
You can add users to your account by going to _Settings > (company) > Manage users_ in the Pipedrive web app. For additional information or special requests, please contact [marketplace.devs@pipedrive.com](mailto:marketplace.devs@pipedrive.com).
