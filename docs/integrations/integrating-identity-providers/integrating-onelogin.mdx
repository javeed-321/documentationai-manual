...
<ExpandableGroup>
  <Expandable title="Why does Scrut require Manage All permission in OneLogin?" default-open="false">
  ...
  <Expandable title="What data does Scrut access using Manage All?" default-open="false">
  ...
  <Expandable title="What happens if an employee is removed from OneLogin?" default-open="false">
  ...
  <Expandable title="Can I use OneLogin for SSO without syncing employee data?" default-open="false">
