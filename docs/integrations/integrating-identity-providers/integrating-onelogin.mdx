...
9. In the **Redirect URIs** field in your OneLogin portal (under Applications → your OIDC app → Configuration), add the following URI: https://scrut.eu.auth0.com/login/callback
   ...
   **Important:** This redirect URI is required for the integration to work with Scrut's Auth0 configuration. The integration will fail without it. To know more, [see here](/docs/frequently-asked-questions-faqs/maintenance-notices/scrut-authentication-system-migration).
   ...
   <Image src="/images/OneLogin-Redirect-URL-3.png" alt="" />
...
3. Click **Integrate**. The OneLogin integration page opens.
   ...
   <Image src="/images/Screenshot-2026-05-12-at-11.10.09.png" alt="" />
...
5. Click **Submit**.
   ...
   <Image src="/images/Screenshot-2026-05-12-at-11.10.30.png" alt="" />
