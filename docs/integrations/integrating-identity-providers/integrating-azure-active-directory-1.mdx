...
<Expandable title="Why is administrator access required?" default-open="true">
...
<ExpandableGroup>
  <Expandable title="What happens when an employee is deleted from Microsoft Entra (Azure AD)?" default-open="true">
  ...
  <Expandable title="Can I control which employees are synced into Scrut?" default-open="true">
  ...
  <Expandable title="How do I trigger a sync before the next scheduled run?" default-open="true">
  ...
  <Expandable title="What if I need to change the administrator account used for this integration?" default-open="true">
    Disconnect the existing integration and reconnect using the updated administrator account.
  </Expandable>

  <Expandable title="Does this integration support Single Sign-On (SSO)?" default-open="true">
  ...
  <Expandable title="Where in Scrut are the employee administrative unit details displayed?" default-open="true">
