...
<ExpandableGroup>
  <Expandable title="What happens when an employee is removed from Google Workspace?" default-open="true">
  ...
  <Expandable title="Can I use the Google Workspace integration without enabling employee directory sync?" default-open="true">
  ...
  <Expandable title="How does the Enable Vendor Discovery toggle work?" default-open="true">
  ...
  <Expandable title="What if my Google Workspace credentials or admin account changes?" default-open="true">
