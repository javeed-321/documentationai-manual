...
<Image src="/images/Screenshot-2025-09-04-at-18.33.39.png" alt="" />
...
3. Locate the **Google Workspace** card and click **Integrate**. You can also use the search bar to find it quickly.
   ...
   <Image src="/images/Screenshot-2025-07-18-at-20.46.53-1.png" alt="" />

4. On the Google Workspace integration page, click **Connect**.

   <Image src="/images/Screenshot-2025-07-18-at-20.50.53.png" alt="" />
...
5. You will be redirected to Google's authentication page. Select your Google Workspace account. If you are not already signed in, you will be prompted to log in first.
   ...
   <Image src="/images/Screenshot-2025-09-04-at-18.32.40.png" alt="" />

6. Review the list of permissions Scrut is requesting and click **Allow**.

   <Image src="/images/Screenshot-2025-09-04-at-18.34.17.png" alt="" />
...
<Image src="/images/Screenshot-2025-09-04-at-18.39.37.png" alt="" />
...
1. Sign in to your Google Admin console and navigate to **Security → Access and data control → API Controls → Manage App Access**.
   ...
   <Image src="/images/Screenshot-2025-09-04-at-18.49.36.png" alt="" />

2. Click **Configure new app**.

   <Image src="/images/Screenshot-2025-09-04-at-18.53.25.png" alt="" />
...
4. Select the Scrut app from the search results.
   ...
   <Image src="/images/Screenshot-2025-09-04-at-18.54.35.png" alt="" />

5. Set the scope to **All Users** and click **Continue**.

   <Image src="/images/Screenshot-2025-09-04-at-18.54.57.png" alt="" />

6. Under Access to Google data, select **Trusted** and click **Continue**.

   <Image src="/images/Screenshot-2025-09-04-at-18.57.04.png" alt="" />

7. Review the configuration summary and click **Finish**.

   <Image src="/images/Screenshot-2025-09-04-at-18.58.26.png" alt="" />
...
<Image src="/images/Screenshot-2025-09-04-at-19.06.29.png" alt="" />
...
- Navigate to **Tests** to view automated test coverage driven by Google Workspace data. Apply the Filter with G Suite selected to view tests only for Google Workspace.
  ...
  <Image src="/images/Screenshot-2026-03-11-at-19.49.36.png" alt="" />
