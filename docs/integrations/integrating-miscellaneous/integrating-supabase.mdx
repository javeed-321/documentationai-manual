...
<ExpandableGroup>
  <Expandable title="Can I use a legacy access token instead of generating a new token?" default-open="true">
  ...
  <Expandable title="Can I use an existing Personal Access Token instead of generating a new one?" default-open="true">
  ...
  <Expandable title="What happens if I revoke the Personal Access Token in Supabase?" default-open="true">
    The integration stops syncing data. Generate a new token in Supabase and submit it in Scrut to restore the connection.
  </Expandable>

  <Expandable title="How often does Scrut sync data from Supabase?" default-open="true">
  ...
  <Expandable title="How do I know if the integration is working?" default-open="true">
  ...
  <Expandable title="What happens when my Personal Access Token expires?" default-open="true">
