...
2. Select **Account** from the dropdown menu.
   ...
   <Image src="/images/Screenshot-2026-08-12-at-11.44.42.png" alt="" />

3. In the left sidebar, click **Access Tokens**.

4. Click **Generate new token**.

   <Image src="/images/Screenshot-2026-08-12-at-11.45.25.png" alt="" />
...
7. Click **Generate token**.
   ...
   <Image src="/images/Screenshot-2026-08-12-at-11.46.05.png" alt="" />

8. Click **Copy** to copy the generated token.

   <Image src="/images/Screenshot-2026-08-12-at-11.46.36.png" alt="" />
...
2. On the **Integrations Library** page, find the Supabase card and click **Integrate**.
   ...
   <Image src="/images/Screenshot-2026-08-12-at-11.47.49.png" alt="" />

3. On the Supabase integration page, paste the token you copied from Supabase into the PAT Token field.

4. Click **Submit**.

   <Image src="/images/Screenshot-2026-08-12-at-11.48.13.png" alt="" />
...
<Image src="/images/Screenshot-2026-08-12-at-11.48.43.png" alt="" />
...
<ExpandableGroup>
  <Expandable title="Can I use a legacy access token instead of generating a new token?" default-open="true">
    ...
    <Image src="/images/Screenshot-2026-08-11-at-9.01.59-PM.png" alt="" />
