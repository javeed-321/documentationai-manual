...
3. Select **Profile Settings**.
   ...
   <Image src="/images/Screenshot-2026-05-20-at-11.50.08.png" alt="" />

4. Under Your API Key on the right side of the page, click **Show API Key**.

   <Image src="/images/Screenshot-2026-05-20-at-11.51.11.png" alt="" />

5. Copy the API key displayed.

   <Image src="/images/Screenshot-2026-05-20-at-11.52.39.png" alt="" />
...
4. Click **Integrate**.
   ...
   <Image src="/images/Screenshot-2026-05-20-at-11.54.58.png" alt="" />
...
7. Click **Submit**.
   ...
   <Image src="/images/Screenshot-2026-05-20-at-11.55.38.png" alt="" />
...
1. On the Freshservice integration page, click **Configure Scope**.
   ...
   <Image src="/images/Screenshot-2026-05-20-at-12.07.22.png" alt="" />
...
4. Click **Save**.
   ...
   <Image src="/images/Screenshot-2026-05-20-at-11.59.14.png" alt="" />
...
<Image src="/images/Screenshot-2026-05-20-at-11.56.47.png" alt="" />
...
2. Click the three-dot icon at the top-right of the page and select **Create Freshservice Ticket**.
   ...
   <Image src="/images/Screenshot-2026-06-25-at-11.36.28.png" alt="" />
...
3. Click **Create** and select **Link Existing Tickets** from the dropdown.
   ...
   <Image src="/images/Screenshot-2026-06-23-at-21.56.29.png" alt="" />
...
<Image src="/images/Screenshot-2026-06-25-at-14.01.10.png" alt="" />
...
<Image src="/images/Screenshot-2026-06-25-at-13.37.47.png" alt="" />
...
2. Click **Add Attachment**.
   ...
   <Image src="/images/Screenshot-2026-05-20-at-12.12.35.png" alt="" />

3. Navigate to the **Scrut Monitor** tab and click **Configure** on the Freshservice monitor card.

   <Image src="/images/Screenshot-2026-05-20-at-14.32.25.png" alt="" />
...
8. Click **Save** to create the monitor.
   ...
   <Image src="/images/Screenshot-2026-05-20-at-14.37.10.png" alt="" />
...
<Image src="/images/Screenshot-2026-05-20-at-14.47.49.png" alt="" caption="Sample CSV file attached to the evidence via Scrut Monitor" />
