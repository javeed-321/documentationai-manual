...
<ExpandableGroup>
  <Expandable title="What permissions does the MongoDB API key need?" default-open="false">
  ...
  <Expandable title="What happens if I regenerate my MongoDB API key?" default-open="false">
  ...
  <Expandable title="Does this integration support MongoDB deployments outside of Atlas?" default-open="false">
