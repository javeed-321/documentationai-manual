...
<ExpandableGroup>
  <Expandable title="Which authentication method should I use, API Key or OAuth?" default-open="true">
  ...
  <Expandable title="Do I need to enter a Client Secret for the OAuth method?" default-open="true">
    No. Databricks OAuth uses PKCE, which doesn't require or generate a client secret. Leave that field blank in Scrut.
  </Expandable>

  <Expandable title="What happens if my Personal Access Token expires or is revoked?" default-open="true">
  ...
  <Expandable title="Can I switch from one authentication method to another later?" default-open="true">
  ...
  <Expandable title="What access does Scrut need in my Databricks account?" default-open="true">
