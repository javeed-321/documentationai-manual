...
3. Find your Account Identifier using the steps in the [Before You Begin section](/docs/integrations/database/integrating-snowflake#before-you-begin-fetch-your-account-identifier) above.
...
3. Scroll to the **Snowflake** tile and click **Integrate**.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788165805270-dpk0nxutfg5-Screenshot-2026-06-23-at-11-04-58.png?fm=auto&auto=compress%2Cformat" alt="" />
...
5. Click **Submit**.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788165807481-19bog348hkh-Screenshot-2026-06-23-at-17-59-02.png?fm=auto&auto=compress%2Cformat" alt="" />
...
<ExpandableGroup>
  <Expandable title="Which authentication method should I use?" default-open="false">
  ...
  <Expandable title="Can I change the authentication method after the integration is set up?" default-open="false">
  ...
  <Expandable title="What happens if I rotate or change my Snowflake credentials?" default-open="false">
  ...
  <Expandable title="How often does Scrut sync data from Snowflake?" default-open="false">
  ...
  <Expandable title="What happens if a user is deleted in Snowflake?" default-open="false">
