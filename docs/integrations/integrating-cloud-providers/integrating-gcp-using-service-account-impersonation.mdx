...
<ExpandableGroup>
  <Expandable title="Does Scrut receive persistent credentials or keys?" default-open="false">
  ...
  <Expandable title="What is the name of the service account created in my project?" default-open="false">
  ...
  <Expandable title="Which IAM roles does Scrut require on my GCP project?" default-open="false">
  ...
  <Expandable title="Does Scrut need Owner, Editor, or Admin roles?" default-open="false">
    No. Scrut does not require Owner, Editor, or Admin roles.
  </Expandable>

  <Expandable title="What permissions does Scrut’s central service account need?" default-open="false">
  ...
  <Expandable title="Which Google APIs need to be enabled for this integration?" default-open="false">
  ...
  <Expandable title="What can Scrut do with this access?" default-open="false">
    Scrut can:
  ...
  <Expandable title="Are Scrut’s actions in my account auditable?" default-open="false">
    Yes. Every action taken by Scrut is logged in your Cloud Logging as `scrut-cp-sa` impersonating `scrut-gcp-scanner`.
  </Expandable>

  <Expandable title="Does Scrut require any write permissions?" default-open="false">
    No. Scrut does not request any write, delete, modify, or deploy permissions.
  </Expandable>

  <Expandable title="How does Scrut follow the principle of least privilege for this integration?" default-open="false">
  ...
  <Expandable title="How does the impersonation model work?" default-open="false">
  ...
  <Expandable title="Why does Scrut need the Token Creator role?" default-open="false">
