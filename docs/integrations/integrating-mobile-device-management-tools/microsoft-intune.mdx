...
<ExpandableGroup>
  <Expandable title="What happens if a device is removed from Microsoft Intune?" default-open="true">
  ...
  <Expandable title="Can I sync data more frequently than every 24 hours?" default-open="true">
  ...
  <Expandable title="What does “Consent on behalf of your organization” mean?" default-open="true">
  ...
  <Expandable title="How do I find the synced device data in Scrut?" default-open="true">
