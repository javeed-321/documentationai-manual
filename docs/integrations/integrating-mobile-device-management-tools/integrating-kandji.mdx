...
8. To enable **Prism API permissions** for antivirus detection, click the three-dot menu (vertical ellipsis) next to the Scrut API token and select **View**.
   ...
   <Image src="/images/image-1773386367387.png" alt="" />
...
10. Enable Gatekeeper and XProtect: /api/v1/prism/gatekeeper_and_xprotect.
    ...
    <Image src="/images/image-1773386443290.png" alt="" />
...
3. Click **Integrate** on the Kandji tile.
   ...
   <Image src="/images/Screenshot-2026-03-13-at-12.52.51.png" alt="" />

4. Enter the **API Token** and the **Kandji API URL** you copied from Kandji.

5. Click **Save**.

   <Image src="/images/Screenshot-2026-03-13-at-12.53.10.png" alt="" />
