...
<ExpandableGroup>
  <Expandable title="What happens when an employee is suspended in JumpCloud?" default-open="false">
  ...
  <Expandable title="What happens if I add a new employee to a JumpCloud group that is already synced to Scrut?" default-open="false">
  ...
  <Expandable title="Can I sync data from more than one JumpCloud group?" default-open="false">
  ...
  <Expandable title="Why is my employee’s password manager showing as non-compliant even though they have the browser extension installed?" default-open="false">
