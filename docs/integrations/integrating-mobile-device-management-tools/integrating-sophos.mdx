...
2. Go to **My Products → General Settings**.
   ...
   <Image src="/images/Screenshot-2025-05-15-at-18.47.02.png" alt="" />

3. Click **API Credentials Management.**

   <Image src="/images/Screenshot-2025-05-15-at-18.48.09.png" alt="" />
...
7. Click **Add**.
   ...
   <Image src="/images/Screenshot-2025-05-15-at-18.51.33.png" alt="" />

8. Copy and save the **Client ID** and **Client Secret**.

   <Image src="/images/Screenshot-2025-05-15-at-18.53.45.png" alt="" />
...
3. Scroll to the Sophos tile and click **Integrate**.
   ...
   <Image src="/images/Screenshot-2025-05-15-at-19.25.21.png" alt="" />
...
5. Click **Submit**.
   ...
   <Image src="/images/Screenshot-2025-05-15-at-19.26.47.png" alt="" />

6. Once authorization is done, you’ll see the “**Connected Successfully**” message and the **Connected** status indicator.

   <Image src="/images/Screenshot-2025-05-15-at-19.27.11.png" alt="" />
...
<Image src="/images/Screenshot-2025-05-15-at-19.23.13.png" alt="" />
...
<Image src="/images/Screenshot-2025-05-15-at-19.00.49.png" alt="" />
...
<Image src="/images/Screenshot-2025-05-15-at-19.08.46.png" alt="" />
...
3. On the Employee page, click the **Technicals** tab to view the data Scrut fetches from Sophos.
   ...
   <Image src="/images/Screenshot-2025-05-15-at-19.10.31.png" alt="" />
...
<Image src="/images/Screenshot-2025-05-15-at-19.04.32.png" alt="" />
