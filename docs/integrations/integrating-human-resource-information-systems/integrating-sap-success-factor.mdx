...
1. In your Admin Center, go to Tools, and search for *Manage OAuth2 Client Applications* (If your page looks different, search for Manage OAuth2 Client Applications in the search tool on your homepage).
...
4. Click *Generate X.509 Certificate*. Fill out Common Name (name doesn't matter) and click **Generate**.
