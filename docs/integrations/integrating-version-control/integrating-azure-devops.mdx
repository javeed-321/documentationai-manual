...
<Image src="/images/Configure-Scope-Azure-DevOps.gif" alt="" />
...
3. Find and select **Azure DevOps**, then click **Integrate**.
   ...
   <Image src="/images/Screenshot-2026-04-20-at-12.29.50.png" alt="" />

4. On the Azure DevOps integration page, click **Connect**.

   <Image src="/images/Screenshot-2026-04-20-at-12.38.21.png" alt="" />
...
5. Scrut redirects you to the Microsoft authentication page. Sign in with your Azure DevOps credentials and click **Accept** to grant the required permissions.
   ...
   <Image src="/images/Screenshot-2025-06-26-at-10.40.41.png" alt="" />
...
<Image src="/images/image-1776669038952.png" alt="" />
