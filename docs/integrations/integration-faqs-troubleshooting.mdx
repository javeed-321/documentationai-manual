...
<ExpandableGroup>
  ...
  <Expandable title="How often are the scans run?" default-open="true">
...
<ExpandableGroup>
  ...
  <Expandable title="How often does Scrut sync with my version control system?" default-open="true">
  ...
  <Expandable title="Why doesn’t Scrut automatically detect my default branch name?" default-open="true">
...
<ExpandableGroup>
  ...
  <Expandable title="Does Scrut automatically offboard employees when they are deleted or deactivated in my HRIS/IDP?" default-open="true">
...
<ExpandableGroup>
  ...
  <Expandable title="How are employees offboarded if only the IdP is connected?" default-open="true">
...
<ExpandableGroup>
  ...
  <Expandable title="Can I connect multiple MDM tools in a single Scrut workspace?" default-open="true">
