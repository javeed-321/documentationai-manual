...
3. Select **Application Keys** from the left panel. If you are on an EU instance, navigate to the EU Application Keys page.
   ...
   <Image src="/images/Screenshot-2026-04-20-at-20.47.21.png" alt="" />
...
6. Copy the generated Application Key.
   ...
   **Note:** Datadog displays the Application Key and API key values only once. Copy and store it before closing the dialog.
   ...
   <Image src="/images/Screenshot-2026-04-20-at-20.56.01.png" alt="" />
...
7. To create an API Key: In Organization Settings, select **API Keys** from the left panel. If you are on an EU instance, navigate to the EU API Keys page.
   ...
   <Image src="/images/Screenshot-2026-04-20-at-20.56.28.png" alt="" />

8. Click **New Key**, assign it a name, and copy the generated value.

   <Image src="/images/Screenshot-2026-04-20-at-20.51.52.png" alt="" />
...
4. Click **Integrate**.
   ...
   <Image src="/images/Screenshot-2026-04-20-at-20.39.30.png" alt="" />
...
6. Click **Submit**.
   ...
   <Image src="/images/Screenshot-2026-04-20-at-20.52.25.png" alt="" />
