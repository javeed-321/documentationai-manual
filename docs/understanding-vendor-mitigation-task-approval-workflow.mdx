...
metaDescription: "Understand how the mitigation task approval workflow works in the Vendor module in Scrut."
---
...
#### Step 1: [Create and Assign a Vendor Mitigation Task](/docs/creating-mitigation-task)

#### Step 2: [Assignee Uploads Documents to the Mitigation Task](/docs/uploading-attachments-and-adding-comments)

#### Step 3: [Admin Approves the Document to Mark the Task as Approved](/docs/approving-vendor-mitigation-task)
