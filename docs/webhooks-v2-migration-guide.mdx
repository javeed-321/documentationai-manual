---
title: "Webhooks v2 migration guide"
---
...
You can find out more about version 1 of webhooks [here](/docs/guide-for-webhooks) and version 2 [here](/docs/guide-for-webhooks-v2).
...
3. As there are significant differences in webhooks v2's payload, please closely review v2's [changes](/docs/webhooks-v2-migration-guide#general-changes-in-webhooks-v2), [format](/docs/webhooks-v2-migration-guide#webhooks-v2-format) and [examples](/docs/webhooks-v2-migration-guide#webhooks-v2-examples) and modify your code accordingly
...
<CodeGroup tabs="Create activity,Update activity,Delete activity">
...
<CodeGroup tabs="Create deal,Update deal,Delete deal">
  ```json title="Create deal"
  {
    "data": {
...
<CodeGroup tabs="Create deal product,Update deal product,Delete deal product">
  ```json title="Create deal product"
  {
    "data": {
      "id": 1,
      "deal_id": 10,
      ...
      "active_flag": true,
      "enabled_flag": true,
      "add_time": "2026-05-22T09:40:54.000Z",
      "last_edit": "2026-05-22T09:40:54.000Z",
      "comments": null,
      "tax": 24,
    ...
    "meta": {
      ...
      "id": "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
      "is_bulk_edit": false,
      "timestamp": "2026-05-22T09:40:54.430Z",
      "type": "general",
      "user_id": "123456",
      "version": "2.0",
      "webhook_id": "111",
  ...
  ```json title="Update deal product"
  {
    "data": {
      "id": 1,
      "deal_id": 10,
      ...
      "enabled_flag": true,
      "add_time": "2026-05-22T09:40:54.000Z",
      "last_edit": "2026-05-22T09:41:42.000Z",
      "comments": "",
      "tax": 24,
      "tax_method": "inclusive",
      "billing_frequency": "one-time",
    ...
    "meta": {
      ...
      "id": "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
      "is_bulk_edit": false,
      "timestamp": "2026-05-22T09:41:42.083Z",
      "type": "general",
      "user_id": "123456",
      "version": "2.0",
      "webhook_id": "111",
  ...
  ```json title="Delete deal product"
  {
    "data": null,
    "previous": {
      "id": 1,
    ...
    "meta": {
      ...
      "id": "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
      "is_bulk_edit": false,
      "timestamp": "2026-05-22T09:42:13.967Z",
      "type": "general",
      "user_id": "123456",
      "version": "2.0",
      "webhook_id": "111",
...
<CodeGroup tabs="Create deal installment,Update deal installment,Delete deal installment">
  ```json title="Create deal installment"
  {
    "data": {
      "id": 1,
      "deal_id": 10,
      ...
      "created_by": 123456,
      "add_time": "2026-05-22T09:45:33.000Z",
      "update_time": "2026-05-22T09:45:33.000Z"
    },
    "previous": null,
    "meta": {
      "action": "create",
      ...
      "correlation_id": "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
      "entity_id": "1",
      "entity": "deal_installment",
      "id": "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
      "is_bulk_edit": false,
      "timestamp": "2026-05-22T09:45:33.838Z",
      "type": "general",
      "user_id": "123456",
      "version": "2.0",
      "webhook_id": "111",
  ...
  ```json title="Update deal installment"
  {
    "data": {
      "id": 1,
      "deal_id": 10,
      ...
      "created_by": 123456,
      "add_time": "2026-05-22T09:47:55.000Z",
      "update_time": "2026-05-22T09:48:33.000Z"
    },
    "previous": {
      "billing_date": "2026-06-01",
      "update_time": "2026-05-22T09:47:55.000Z"
    },
    "meta": {
      "action": "change",
      "company_id": "12345",
      ...
      "id": "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
      "is_bulk_edit": false,
      "timestamp": "2026-05-22T09:48:33.398Z",
      "type": "general",
      "user_id": "123456",
      "version": "2.0",
      "webhook_id": "111",
  ...
  ```json title="Delete deal installment"
  {
    "data": null,
    "previous": {
      "id": 1,
    ...
    "meta": {
      ...
      "id": "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
      "is_bulk_edit": false,
      "timestamp": "2026-05-22T09:49:02.236Z",
      "type": "general",
      "user_id": "123456",
      "version": "2.0",
      "webhook_id": "111",
...
<CodeGroup tabs="Create lead,Update lead,Delete lead">
  ```json title="Create lead"
  {
    "data": {
...
<CodeGroup tabs="Create note,Update note,Delete note">
  ```json title="Create note"
  {
    "data": {
      "id": 1,
      "user_id": 12415231,
...
<CodeGroup tabs="Create organization,Update organization,Delete organization">
  ```json title="Create organization"
  {
    "data": {
      "add_time": "2022-11-24T13:18:55Z",
      "address": null,
  ...
  ```json title="Update organization"
  {
    "data": {
      "add_time": "2022-11-24T13:18:55Z",
      "address": null,
  ...
  ```json title="Delete organization"
  {
    "data": null,
    "previous": {
      "add_time": "2022-11-24T13:18:55Z",
...
<CodeGroup tabs="Create person,Update person,Delete person">
  ```json title="Create person"
  {
    "data": {
      "add_time": "2022-11-24T13:18:55Z",
      "custom_fields": {},
...
<CodeGroup tabs="Create pipeline,Update pipeline,Delete pipeline">
  ```json title="Create pipeline"
  {
    "data": {
      "id": 9,
...
<CodeGroup tabs="Create product,Update product,Delete product">
  ```json title="Create product"
  {
    "data": {
...
<CodeGroup tabs="Create project,Update project,Delete project">
  ```json title="Create project"
  {
    "data": {
      "id": 2,
      "title": "Example Project",
      "description": "Description",
      "add_time": "2026-04-10T08:06:30.180Z",
      "update_time": "2026-04-10T08:06:30.180Z",
      "start_date": "2026-04-10",
      "end_date": "2026-04-17",
      "status": "open",
      "status_change_time": "2026-04-10T08:06:30.180Z",
      "owner_id": 12345,
      "archive_time": null,
      "board_id": 1,
      "phase_id": 1,
    ...
    "meta": {
      "action": "create",
      "company_id": "12345",
      "correlation_id": "1bb656c0-27ed-4497-a243-051f89731014",
      "entity_id": "2",
      "entity": "project",
      "id": "d0b732a4-626a-4b07-be55-0114ff493b92",
      "is_bulk_edit": false,
      "timestamp": "2026-04-10T08:06:30.226Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
  ...
  ```json title="Update project"
  {
    "data": {
      ...
      "description": "Description",
      "add_time": "2026-04-10T08:06:30.180Z",
      "update_time": "2026-04-10T08:07:16.579Z",
      "start_date": "2026-04-10",
      "end_date": "2026-04-17",
      "status": "open",
      "status_change_time": "2026-04-10T08:06:30.180Z",
    ...
    "meta": {
      "action": "change",
      "company_id": "12345",
      "correlation_id": "2f75bb6e-7228-48ba-9d98-ef906d60f529",
      "entity_id": "2",
      "entity": "project",
      "id": "c2d7fe1a-e48c-4dc1-b484-11d9ecb175a8",
      "is_bulk_edit": false,
      "timestamp": "2026-04-10T08:07:16.644Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
  ...
  ```json title="Delete project"
  {
    ...
    "meta": {
      "action": "delete",
      "company_id": "12345",
      "correlation_id": "58adeb7b-52c7-4a02-b5fa-9d85443c259a",
      "entity_id": "2",
      "entity": "project",
      "id": "bc094dcb-0c83-45ab-b904-c249704b1205",
      "is_bulk_edit": false,
      "timestamp": "2026-04-10T08:07:28.905Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
...
<CodeGroup tabs="Create project phase,Update project phase,Delete project phase">
  ```json title="Create project phase"
  {
    "data": {
      "id": 6,
      "name": "Kick-off",
      "board_id": 2,
      "order_nr": 1,
      "add_time": "2026-04-10T08:07:50.000Z",
      "update_time": "2026-04-10T08:07:50.000Z"
    },
    "previous": null,
    "meta": {
      "action": "create",
      "company_id": "12345",
      "correlation_id": "c6241d07-a077-4262-a169-9d9ff9884017",
      "entity_id": "6",
      "entity": "phase",
      "id": "91b8c612-6227-492f-8a2c-0afa61455e3e",
      "is_bulk_edit": false,
      "timestamp": "2026-04-10T08:07:50.072Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
  ...
  ```json title="Update project phase"
  {
    "data": {
      "id": 11,
      "name": "New Phase",
      "board_id": 1,
      "order_nr": 6,
      "add_time": "2026-04-10T08:09:45.000Z",
      "update_time": "2026-04-10T08:09:50.000Z"
    },
    "previous": {
      "name": "Phase",
      "update_time": "2026-04-10T08:09:45.000Z"
    },
    "meta": {
      "action": "change",
      "company_id": "12345",
      "correlation_id": "035b9f74-90ec-4381-8f79-e069dd26a6fd",
      "entity_id": "11",
      "entity": "phase",
      "id": "331d4b99-7b8d-4ae8-ad6a-425fd3bdb496",
      "is_bulk_edit": true,
      "timestamp": "2026-04-10T08:09:50.931Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
  ...
  ```json title="Delete project phase"
  {
    "data": null,
    "previous": {
      "id": 9,
    ...
    "meta": {
      "action": "delete",
      "company_id": "12345",
      "correlation_id": "8fbfcdee-e3b8-4ebd-97af-afad680658f0",
      "entity_id": "9",
      "entity": "phase",
      "id": "b301317b-c594-4f12-84e0-a62053257ae8",
      "is_bulk_edit": true,
      "timestamp": "2026-04-10T08:08:37.645Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
...
<CodeGroup tabs="Create project board,Update project board,Delete project board">
  ```json title="Create project board"
  {
    "data": {
      "id": 2,
      "name": "New board",
    ...
    "meta": {
      ...
      "entity_id": "2",
      "entity": "board",
      "id": "ccb0fd78-5d84-48d9-883e-55d0e2f975bb",
      "is_bulk_edit": false,
      "timestamp": "2026-04-10T08:07:50.068Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
  ...
  ```json title="Update project board"
  {
    "data": {
      "id": 2,
      "name": "Example board",
      "order_nr": 2,
      "add_time": "2026-04-10T08:07:50.000Z",
      "update_time": "2026-04-10T08:08:26.000Z"
    },
    "previous": {
      "name": "New board",
      "update_time": "2026-04-10T08:07:50.000Z"
    ...
    "meta": {
      "action": "change",
      "company_id": "12345",
      "correlation_id": "55759039-deb1-4f41-a886-75caacd2082a",
      "entity_id": "2",
      "entity": "board",
      "id": "ff9b16c1-a899-484f-a048-1b777cb2f070",
      "is_bulk_edit": false,
      "timestamp": "2026-04-10T08:08:26.954Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
  ...
  ```json title="Delete project board"
  {
    "data": null,
    "previous": {
      "id": 2,
    ...
    "meta": {
      ...
      "entity_id": "2",
      "entity": "board",
      "id": "b4351d41-9395-402d-91eb-c64f39c1d202",
      "is_bulk_edit": false,
      "timestamp": "2026-04-10T08:08:37.649Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
...
<CodeGroup tabs="Create project task,Update project task,Delete project task">
  ```json title="Create project task"
  {
    "data": {
      "id": 6,
      "title": "Task",
      ...
      "parent_task_id": null,
      "milestone": false,
      "add_time": "2026-04-10T08:10:34.296Z",
      "update_time": "2026-04-10T08:10:34.296Z",
      "start_date": null,
      "due_date": "2026-04-10",
      "done": false,
    ...
    "meta": {
      "action": "create",
      "company_id": "12345",
      "correlation_id": "6a189098-e2c4-4593-9d9d-34cb52247011",
      "entity_id": "6",
      "entity": "task",
      "id": "a8872436-24bc-4969-a8d7-f1d6a0bda5d1",
      "is_bulk_edit": false,
      "timestamp": "2026-04-10T08:10:34.299Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
  ...
  ```json title="Update project task"
  {
    "data": {
      "id": 6,
      "title": "Task",
      ...
      "milestone": false,
      "add_time": "2026-04-10T08:10:34.296Z",
      "update_time": "2026-04-10T08:10:40.808Z",
      "start_date": null,
      "due_date": "2026-04-10",
      "done": false,
      "marked_as_done_time": null,
    ...
    "meta": {
      "action": "change",
      "company_id": "12345",
      "correlation_id": "63b5ac00-b55d-40fc-9715-f6df3f4216b4",
      "entity_id": "6",
      "entity": "task",
      "id": "30be1457-7420-42a3-8ebb-3d69a8864516",
      "is_bulk_edit": false,
      "timestamp": "2026-04-10T08:10:40.810Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
  ...
  ```json title="Delete project task"
  {
    "data": null,
    "previous": {
      "id": 6,
    ...
    "meta": {
      "action": "delete",
      "company_id": "12345",
      "correlation_id": "cc240519-a1b1-4960-bfc7-cbcc67bad165",
      "entity_id": "6",
      "entity": "task",
      "id": "95faa3f8-2dea-4eb7-b299-9f892c2e00be",
      "is_bulk_edit": false,
      "timestamp": "2026-04-10T08:10:56.521Z",
      "type": "general",
      "user_id": "12345",
      "version": "2.0",
      "webhook_id": "12345",
...
<CodeGroup tabs="Create stage,Update stage,Delete stage">
  ```json title="Create stage"
  {
    "data": {
      "id": 48,
      "name": "Sample Stage",
...
<CodeGroup tabs="Create user,Update user,Deactivate user">
  ```json title="Create user"
  {
    ...
    "meta": {
      ...
      "id": "16943176",
      "is_bulk_edit": false,
      "timestamp": "2022-11-24T15:39:49.000Z",
      "type": "general",
      "user_id": "12415231",
      "version": "2.0",
      "webhook_id": "4710827",
  ...
  ```json title="Update user"
  {
    ...
    "meta": {
      ...
      "id": "12415231",
      "is_bulk_edit": false,
      "timestamp": "2022-11-24T15:42:22.000Z",
      "type": "general",
      "user_id": "12415231",
      "version": "2.0",
      "webhook_id": "4710827",
  ...
  ```json title="Deactivate user"
  {
    ...
    "meta": {
      ...
      "id": "15702024",
      "is_bulk_edit": false,
      "timestamp": "2022-11-24T15:46:42.000Z",
      "type": "general",
      "user_id": "12415231",
      "version": "2.0",
      "webhook_id": "4710827",
