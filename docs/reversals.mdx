...
description: "When payments come back"
---
...
_An outbound payment returned via the scheme (Type = POREV) and the PAYIN/PAYOUT webhooks are not in use_
...
<Image src="https://files.readme.io/ba66eabad5aef37e07fabbfaf2dbb25678e7271bed6ed871ac766bb26944bcec-image.png" alt="Image" caption=" " />

## Reconciliation for a Scheme Return - with webhooks

_An outbound payment returned via the scheme (Type = PO\_REV) and the PAYIN/PAYOUT webhooks are subscribed to_
...
<Image src="https://files.readme.io/3878726bac166830938dc12d758e156a038b6c70481d64bb5451f5c57eb3ab9a-image.png" alt="Image" caption=" " />
