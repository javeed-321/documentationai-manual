---
title: "Sandbox: Initiating a cVRP payment"
---
...
<CodeGroup tabs="Initiate payment – request,Initiate payment – response">
  ```json title="Initiate payment – request"
  {
  ...
  ```json title="Initiate payment – response"
  {
    "id": "V21000074D",
    "status": "RECEIVED"
  }
...
```json title="Get payment status – response"
{
  "consentId": "E210000BUJ",
  "payment": {
    "currency": "GBP",
...
<CodeGroup tabs="Expired consent payment request,Expired consent payment response">
  ```json title="Expired consent payment request"
  {
  ...
  ```json title="Expired consent payment response"
  {
    "field": "consentId",
    "code": "INVALID",
...
<CodeGroup tabs="Individual limit exceeded request,Individual limit exceeded response">
  ```json title="Individual limit exceeded request"
  {
  ...
  ```json title="Individual limit exceeded response"
  {
