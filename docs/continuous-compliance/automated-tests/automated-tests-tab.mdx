...
<ExpandableGroup>
  <Expandable title="How does Scrut run the Pass By Default tests?" default-open="false">
  ...
  <Expandable title="Why do I see more items in Fix Required than before?" default-open="false">
  ...
  <Expandable title="How do I know when a test was run?" default-open="false">
  ...
  <Expandable title="Why does the total number of tests keep changing?" default-open="false">
  ...
  <Expandable title="Why should I assign tests to specific users?" default-open="false">
