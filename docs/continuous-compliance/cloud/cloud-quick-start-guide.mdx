...
Sign in to Scrut, and navigate to **Integrations → Cloud Provider** to integrate Scrut with your cloud provider. See here for [step-by-step instructions to connect with your cloud provider](/docs/integrations/integrations-overview#4-cloud-providers).
