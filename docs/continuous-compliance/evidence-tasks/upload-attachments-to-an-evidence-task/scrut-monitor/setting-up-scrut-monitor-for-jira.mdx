...
<ExpandableGroup>
  <Expandable title="What’s included in the generated file attached as evidence?" default-open="true">
  ...
  <Expandable title="Suggest a few best practices to maximize this feature." default-open="true">
    **Query Optimization**
  ...
  <Expandable title="Share a few examples of when to use the Jira - Scrut Monitor." default-open="true">
