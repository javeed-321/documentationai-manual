...
<ExpandableGroup>
  <Expandable title="Which Evidence Tasks can be automated using Scrut Internal Monitor?" default-open="false">
  ...
  <Expandable title="How many Scrut Monitor evidence workflows can I attach to a single artifact?" default-open="false">
