...
description: "Learn how to mark evidence as Fully or Partially Automated in Scrut, confirm automation coverage, upload manual proof when needed, and accurately track"
---
...
2. Click the Evidence Collection chart and select **Partially Automated** to filter the evidence list.
   ...
   **Heads Up!** Evidence tasks with active automation start at Partially Automated by default. Work through this list to confirm coverage for each one.
   ...
   <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788165797243-hyjo1eb434n-Screenshot-2026-06-10-at-11-53-38.png?fm=auto&auto=compress%2Cformat" alt="" />
