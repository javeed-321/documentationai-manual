...
description: "Learn how evidence automation works in Scrut using Automated Tests and Scrut Monitors to collect compliance evidence, track automation coverage, identify"
---
...
- **Automated Tests**: Each entry shows the test name, current status (Passed, Failed, or Ignored), and an Export button to download results without navigating to the Tests page. Click any test to open its detail view.
  ...
  <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788161907015-jef1mqnakl-Automated-Tests-Automation-Source.png?fm=auto&auto=compress%2Cformat" alt="" />
...
- **Scrut Monitors:** Each entry shows the monitor name, frequency, last synced time, and current status (Setup Required, No Data Found, Healthy, and others). Click any monitor to configure it or view details.
  ...
  <Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788166031313-9whd24xhny6-Scrut-Monitor-Automation-Source.png?fm=auto&auto=compress%2Cformat" alt="" />
