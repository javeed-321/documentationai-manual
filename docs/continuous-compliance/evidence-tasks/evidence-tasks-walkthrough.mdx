...
The Evidence Status bar shows the number of evidence tasks under each status. See here to [learn more about each evidence status](/docs/continuous-compliance/evidence-tasks/overview-1/evidence-statuses).
