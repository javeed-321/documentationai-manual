---
title: "Channel Manager - Activities"
---
...
When calling [GET/channel-managers/activities](/reference/channelmanagergetcardactivities) you have a list of parameters that you are able to search by, these are:
