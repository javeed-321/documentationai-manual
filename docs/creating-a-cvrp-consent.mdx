...
Use the [GET ASPSPs API](/reference/getaspsproviders) to fetch the latest list of banks and their supported capabilities. **Only institutions that have `COMMERCIAL_VRP` status `ENABLED` should be offered to the user.**
