...
<ExpandableGroup>
  <Expandable title="Will customers see controls marked as “N/A” or “In Progress”?" default-open="true">
  ...
  <Expandable title="What happens if I mark control documents as private?" default-open="true">
  ...
  <Expandable title="Can I remove a control from the Trust Portal?" default-open="true">
  ...
  <Expandable title="How often should I update my controls?" default-open="true">
