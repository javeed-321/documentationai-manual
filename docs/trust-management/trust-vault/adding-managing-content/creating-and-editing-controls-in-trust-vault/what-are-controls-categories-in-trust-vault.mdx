...
description: "Learn what are controls and categories in Trust Vault and understand the benefits of showcasing them on your Trust Portal."
---
...
- [Rename categories](/docs/trust-management/trust-vault/adding-managing-content/creating-and-editing-controls-in-trust-vault/edit-category-names) to match the terms your customers use
...
<ExpandableGroup>
  ...
  <Expandable title="Can I remove a control from the Trust Portal?" default-open="false">
    See here to [delete a control and remove it from the Trust Portal.](/docs/trust-management/trust-vault/adding-managing-content/creating-and-editing-controls-in-trust-vault/delete-categories-controls)
  </Expandable>
