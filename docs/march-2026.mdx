---
title: "March 2026"
metaDescription: "Scrut's March release adds NEN 7510 for Dutch healthcare, AI gap analysis on policy and evidence dashboards, AI-assisted cloud remediation, and richer"
---
...
<Callout kind="info">
  Learn more: [Teammates evidence gap analysis](/docs/automated-evidence-checker)
</Callout>
...
<Callout kind="info">
  Learn more: [Remediate test findings with Scrut Teammates](/docs/remediating-a-test-finding#1-code-fix-with-teammates)
</Callout>
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788166236337-979f6jn056-third-party-vulnerability-findings.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />

<Callout kind="info">
  Learn more: [Third-party scan details](/docs/understanding-vulnerability-details-page)
</Callout>
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788161872153-rqpmaohe6s-Aikido.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />
...
<Image src="https://blob-cdn.documentation.ai/org-be800fa3-4146-42bb-a54c-66f35fe883a5/doc-4eeb4bca-def5-4b53-9be4-c510946b0c05/1788166120533-bidrxmpakk5-Third-Party-Scans-Resources-Tab.png?fm=auto&auto=compress%2Cformat" alt="" caption=" " />

<Callout kind="info">
  Learn more: [Resources tab in Vulnerabilities](/docs/vulnerabilities-walkthrough#resources-tab)
</Callout>
...
<Callout kind="info">
  Learn more: [Configure auto-approval for requests from trusted domains](/docs/configure-auto-approval-for-specific-domains)
</Callout>
...
<Callout kind="info">
  Learn more: [Managing Tags in the Vault](/docs/managing-tags-in-the-vault)
</Callout>
...
- **Automated Tests scan status:** [Automated Tests show last checked and next scan times](/docs/understanding-scan-status-in-the-tests-module), so outdated or failing tests surface earlier.
...
- **JSONL Test exports:** [JSON Lines (JSONL) exports](/docs/automated-tests-tab#jsonl-export) add metadata and authenticity signals so auditors can verify pass/fail outcomes from integration and internal sources.
...
- **API transparency in Scrut Monitor reports:** [Scrut Monitor reports include the exact API endpoints](/docs/how-to-set-up-scrut-monitor#understanding-the-scrut-monitor-report) used to fetch data, plus documentation links for auditor verification.
