...
<Image src="/images/Screenshot-2026-01-20-at-16.04.43-1.png" alt="" />
...
2. Click on the required application.
   ...
   <Image src="/images/Screenshot-2026-01-20-at-16.05.06.png" alt="" />

3. Click **Upload File**. Alternatively, click **Add New User** to add user details individually.

   <Image src="/images/Screenshot-2026-01-20-at-16.05.25.png" alt="" />
...
5. If the file is not readily available, you can prepare a file (XLSX/CSV) with the user list and ensure it includes the following details for each user:
   ...
   <Image src="/images/Screenshot-2026-01-20-at-16.11.02.png" alt="" />
...
7. Once you’ve mapped all fields in your file to corresponding fields in Scrut, click **Confirm Mapping**.
   ...
   <Image src="/images/Screenshot-2026-01-20-at-16.39.24.png" alt="" />

8. Review the mapped data and click **Import User Access Data**.

   <Image src="/images/Screenshot-2026-01-20-at-16.39.56.png" alt="" />

9. Scrut imports the application's user access data from your uploaded file.

   <Image src="/images/Screenshot-2026-01-20-at-16.41.56.png" alt="" />
...
<Image src="/images/image-1768915098896.png" alt="" />
...
<Image src="/images/Screenshot-2026-01-20-at-16.46.23-1.png" alt="" />
...
<Image src="/images/To-do-list-for-Access-Reviews.png" alt="" />
...
1. Click the **edit icon** for the unmapped user.
   ...
   <Image src="/images/Screenshot-2026-05-08-at-20.15.54.png" alt="" />
...
4. Repeat for each remaining unmapped user.
   ...
   <Image src="/images/Screenshot-2026-05-08-at-20.17.37.png" alt="" />
...
2. Click **Update Account Identity** in the bulk action bar that appears.
   ...
   <Image src="/images/Screenshot-2026-05-08-at-20.19.36.png" alt="" />
...
<Image src="/images/Access-Decision.png" alt="" />
...
4. Click **Create Ticket** and select your connected project management tool to track these tickets.
   ...
   <Image src="/images/Screenshot-2026-05-08-at-20.24.37.png" alt="" />
...
<Image src="/images/Screenshot-2026-01-20-at-18.59.05.png" alt="" />
...
1. Click **Send for Approval** once you've completed reviewing all users. You can also click this button even if you still have pending users.
   ...
   <Image src="/images/image-1769072314436.png" alt="" />

2. Click **Send** to proceed, or **Cancel** to go back.

   <Image src="/images/Screenshot-2026-01-22-at-14.29.52.png" alt="" />
...
- The approver receives notifications via email, Slack, and in the Notifications Center.
  ...
  <Image src="/images/Screenshot-2026-01-22-at-14.30.55-1.png" alt="" />
...
4. You can now edit your previous decisions, make necessary adjustments, and resubmit using the **Send for Approval** button.
   ...
   <Image src="/images/Screenshot-2026-01-22-at-14.46.13-1.png" alt="" />
...
2. Click the application marked as **Pending Approval**.
   ...
   <Image src="/images/Screenshot-2026-01-22-at-14.39.31.png" alt="" />
...
3. You'll see two options:
   ...
   <Image src="/images/Screenshot-2026-01-22-at-14.38.54.png" alt="" />
...
2. Optionally, include a justification for the action, and click **Yes, Approve**.
   ...
   <Image src="/images/Screenshot-2026-01-22-at-14.52.23.png" alt="" />
...
3. Click **Submit** to send the review back to the reviewer.
   ...
   <Image src="/images/Screenshot-2026-01-22-at-14.41.11.png" alt="" />
