...
<Image src="/images/Employee-Portal.png" alt="" />
...
<Tabs>
  <Tab title="Ongoing Tasks">
    ...
    <Image src="/images/Screenshot-2025-06-05-at-18.00.07.png" alt="" />
    ...
    **Note:**
    ...
    - Policies marked with a blue diamond are Scrut-suggested. Scrut recommends adding these to the checklist. Click the **Include Suggested Policies** button to add all Scrut-suggested policies to this checklist.
      ...
      <Image src="/images/Blue-Diamond.png" alt="" />

    - Turn on the **Show Selected Policies** toggle to view all the policies you’ve selected.

    <Image src="/images/Screenshot-2025-11-04-at-19.03.25.png" alt="" />

    ### #2: Install Monitoring Agent

    <Image src="/images/Screenshot-2025-07-16-at-14.32.08.png" alt="" />
    ...
    **How to complete**:
    ...
    <Image src="/images/Screenshot-2025-07-16-at-14.33.15.png" alt="" />
    ...
    **How to complete:** Personnel must install the approved password manager on their devices to complete this task.
    ...
    <Image src="/images/Screenshot-2025-07-16-at-14.34.02.png" alt="" />
    ...
    **How to complete:**
    ...
    <Image src="/images/Adding-Software-in-Checklist.gif" alt="" />
    ...
    **How to complete:** Personnel must install all applications designated as "required software" to complete this task.
    ...
    <Image src="/images/Screenshot-2025-06-05-at-18.10.51.png" alt="" />
    ...
    **How to complete**: Employees log in to the Scrut [employee portal](/docs/people/employee-portal/employee-portal-overview), complete the assigned training campaigns and finish associated quizzes. The training completion status syncs directly into the Employees module.
    ...
    <Image src="/images/Screenshot-2025-06-05-at-18.21.53.png" alt="" />
  ...
  <Tab title="Offboarding Tasks">
    ...
    <Image src="/images/Screenshot-2025-06-05-at-18.22.23.png" alt="" />
    ...
    **How to complete**: Scrut automatically detects account deactivation for applications that you have integrated with the platform.
    ...
    <Image src="/images/Screenshot-2025-06-05-at-18.22.49.png" alt="" />
