...
## Guides: Logs, Metrics, and SIEM integration
- [Real-time Connector Metrics using Datadog, TrafficPeak, and Amazon CloudWatch SIEM providers](https://techdocs.akamai.com/eaa/docs/real-time-connector-metrics-using-siem-providers.md)
- [Real-time Connector Metrics using Splunk SIEM provider](https://techdocs.akamai.com/eaa/docs/real-time-connector-metrics-using-splunk-siem-provider.md)
- [Real-time Connector Metrics using Dynatrace SIEM provider](https://techdocs.akamai.com/eaa/docs/real-time-connector-metrics-using-dynatrace-siem-provider.md)
- [Send Access Logs to Datadog, TrafficPeak, Splunk, and CloudWatch SIEM](https://techdocs.akamai.com/eaa/docs/send-access-logs-to-datadog-trafficpeak-splunk-and-amazon-cloudwatch-siem.md)
- [Send Access logs to Elasticsearch SIEM](https://techdocs.akamai.com/eaa/docs/send-access-logs-to-elasticsearch-siem.md)
- [Use EAA logs with SIEM, API, or Unified Log Streamer (ULS)](https://techdocs.akamai.com/eaa/docs/use-eaa-logs-with-siem-api-or-unified-log-streamer-uls.md)
