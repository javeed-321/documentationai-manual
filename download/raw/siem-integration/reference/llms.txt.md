...
- [API index](https://techdocs.akamai.com/siem-integration/reference/api/llms.txt): full category index
...
- [Security Events index](https://techdocs.akamai.com/siem-integration/reference/security-events/llms.txt): full category index
