...
```json
{
  ...
  "components": {
    "schemas": {
      ...
      "channelmanager.CardEnquiryRequest": {
        "type": "object",
        "description": "Enquiry",
        "properties": {
          "pan": {
      ...
      "channelmanager.CardResponse": {
        ...
        "properties": {
          ...
          "constraints": {
            "$ref": "#/components/schemas/channelmanager.CardConstraints",
          ...
          "authentication": {
            "$ref": "#/components/schemas/channelmanager.CardThreeDSecureAuthentication",
          ...
          "customFields": {
            ...
            "items": {
              "$ref": "#/components/schemas/channelmanager.CardCustomFieldResponse"
            }
          },
          "authWindow": {
            "$ref": "#/components/schemas/channelmanager.AuthorisationWindow",
      ...
      "channelmanager.CardConstraints": {
        "type": "object",
        "properties": {
          "mccWhitelist": {
            "type": "array",
      ...
      "channelmanager.CardCustomFieldResponse": {
        "type": "object",
        "properties": {
          "key": {
            "type": "string",
      ...
      "channelmanager.AuthorisationWindow": {
        "type": "object",
        "properties": {
          "startDate": {
            "type": "string",
