      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "explode": true,
            "schema": {
              "$ref": "#/components/schemas/card.reportTypes"
            },
          ...
          },
          {
            ...
            "explode": true,
            "schema": {
              "$ref": "#/components/schemas/card.reportSubjectIds"
            },
            "example": "C1000001"
          },
          {
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/card.ReportPageResponse"
                }
              }
            }
          },
      ...
      "card.ReportPageResponse": {
        ...
        "properties": {
          "content": {
            ...
            "items": {
              "$ref": "#/components/schemas/card.ReportResponse"
            }
          },
          "size": {
            "type": "integer",
