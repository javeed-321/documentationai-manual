---
updatedAt: 2025-09-05T18:36:25.000Z
---
...
PIN value can be retrieved and passed to the cardholder via [Retrieve PIN](https://modulr.readme.io/reference/retrievepin) endpoint (if you are PCI DSS compliant) or by the cardholder directly via [Retrieve secure card details](https://modulr.readme.io/docs/retrieve-secure-card-details) mechanism.
...
Online PIN value can be changed via [Reset card PIN](https://modulr.readme.io/reference/resetpin) endpoint (if you are PCI DSS compliant), via [Secure Reset card PIN](https://modulr.readme.io/reference/secureresetpin) endpoint if you are using the [Retrieve secure card details](https://modulr.readme.io/docs/retrieve-secure-card-details) solution or at ATM.
