---
updatedAt: 2025-09-05T18:48:09.000Z
---
...
To obtain what reports are available to you each day / month you will need to first call [GET/channel-managers/card-reports](https://modulr.readme.io/reference/channelmanagersearchcardreports) which will return back a list of the report ID’s that are available to you.
...
Once you have a list of the report ID’s then you will need to send a further call to [GET/channel-managers/card-reports/\{id}/report](https://modulr.readme.io/reference/channelmanagerretrievereport) to get back the CSV file of that specific report
