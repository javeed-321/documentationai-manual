...
<Image align="center" border={false} width="200px" src="https://files.readme.io/4045202444264e61b12107a5cff803727b1ed1e46a61727f50a61ac0c19b1d72-image.png" />
...
Santander is introducing three different brands and we have mapped them to new unique id in the responses in our [APIs](https://modulr.readme.io/reference/getaspsproviders):
...
These new IDs are already available via Modulr’s /[getaspspproviders](https://modulr.readme.io/reference/getaspsproviders) endpoint and should be used for all new PIS payments going forward.
