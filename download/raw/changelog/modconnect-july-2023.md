...
<Image align="center" src="https://files.readme.io/cf33e11-MC_strip_2.png" />
...
You can now initiate payments from accounts at Starling Bank.  You can find our full supported bank list and read about how to use the provider list [API in our Developer Guide.](https://modulr.readme.io/docs/supported-banks-and-aspsps)

## Enhancements / Bugs Resolved

### Cards | Status Changes

Now you can see which cards have expired. Previously the status of a card was updated from EXPIRED to CANCELLED when a replacement was initiated.  [Find out more here.](https://modulr.readme.io/docs/supported-banks-and-aspsps)
...
To find out how to subscribe [here](https://modulr.readme.io/reference/addcustomernotification)  and for more information, click[ here. ](https://modulr.readme.io/docs/webhook-account-status-change)
