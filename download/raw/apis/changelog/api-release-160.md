...
```json GET: "/back-office/asset-transfers/acats/{assetTransferID}"
{
  ...
  "rejectionInfo": {  
...
```json POST: "/back-office/asset-transfers/acats"
{  
  ...  
  "clearingNo": "1234" ✅  
  ...  
...
```json GET: "/back-office/accounts/{accountID}/summary/violations"
{  
  ... 
...
```json POST: "/back-office/transfers/cancel-rebills"
{  
  "orderNo": "KCYC000204",  
...
```json GET:"/back-office/instruments/{symbolOrInstrumentID}"
{  
