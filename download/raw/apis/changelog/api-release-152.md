...
```Text Add Compliance Entity to account
POST /accounts
...
```
```Text Delete Compliance Vendor from account
PATCH /accounts/accountID
...
> ❗️ **Note: No file will be generated if the entity account list is empty.**
...
> ❗️ Any new vendors need to be announced to DriveWealth beforehand and DriveWealth will accordingly add the new entries to the list of allowed vendors.
