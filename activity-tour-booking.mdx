...
description: >-
  ...
  Test Design canvas.
type: guide
heading: 'Mintlify Pricing: Plans, AI Credits, Enterprise Pricing & Hidden Costs'
deck: >-
  Understand how Mintlify's pricing actually works, from Pro and Enterprise
  plans to AI credits, rollover, overages, and real-world cost scenarios so you
  can estimate your total monthly spend before you buy.
author: roopreddy
category: comparisons
cover: ./cover.png
cta:
  eyebrow: Comparing the bill?
  headline: The free tier is a real tier
  body: >-
    No contact-sales wall before an upgrade, and no per-seat surprise at
    renewal.
  action:
    label: Start free
    href: signup
