...
<Image src="https://files.readme.io/bfa47e2f8bd741f311dc875bfd8bc63d6af500d13cff430717e7ea0e56a7430f-image.png" alt="Image" caption=" " />
...
You can find further information of the new payment status codes in our updated documentation [Open Banking V4 API Transition Guide.](/docs/open-banking-v4-api-transition)
...
👉 For more on how PIS works, check out our[ PISP documentation.](/docs/pisp)

📄 For the full list of supported banks, please see [Supported ASPSP (Banks).](/docs/supported-banks-and-aspsps)
...
**🛠️ How does the request API work?**&#x4D;odulr partners and clients will be able to integrate this new API into their own customer journeys. We’ve made draft API documentation available [EU Verification of Payee (VoP) ](/docs/eu-verification-of-payee-vop) - for any check, a simple set of results are returned:
...
- Review the draft [Verification of Payee (VoP) ](/docs/eu-verification-of-payee-vop) API documentation and plan your roadmap to deliver changes for the October deadline.
