---
title: "Your Modulr Product Update May 2026"
---
...
Review your integration against the updated status lifecycle and ensure your polling logic handles the two new values. For full API reference, see [https://modulr.readme.io/reference/upload-payment-file](/reference/upload-payment-file)
...
[https://modulr.readme.io/docs/managing-direct-debit-indemnity-claims-ddic#/](/docs/managing-direct-debit-indemnity-claims-ddic#/)

[https://modulr.readme.io/docs/webhook-direct-debit-collections-ddic#/](/docs/webhook-direct-debit-collections-ddic#/)
