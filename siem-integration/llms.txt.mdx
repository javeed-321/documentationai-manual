...
- [Guides index](https://techdocs.akamai.com/siem-integration/docs/llms.txt): full section index
- [Get started](https://techdocs.akamai.com/siem-integration/docs/get-started/llms.txt)

## API Reference

- [API Reference index](https://techdocs.akamai.com/siem-integration/reference/llms.txt): full section index
- [API](https://techdocs.akamai.com/siem-integration/reference/api/llms.txt)
- [Security Events](https://techdocs.akamai.com/siem-integration/reference/security-events/llms.txt)

## Recipes

- [Recipes index](https://techdocs.akamai.com/siem-integration/recipes/llms.txt): full section index

## Changelog

- [Changelog index](https://techdocs.akamai.com/siem-integration/changelog/llms.txt): full section index
