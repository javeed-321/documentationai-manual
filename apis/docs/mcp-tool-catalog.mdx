...
| Label          | Meaning                                                                   |
| :------------- | :------------------------------------------------------------------------ |
| _(blank)_      | No restriction stated in schema                                           |
...
| Tool          | Endpoint        | Status | Description                                                                                                                          |
| :------------ | :-------------- | :----- | :----------------------------------------------------------------------------------------------------------------------------------- |
| `search_docs` | _(none stated)_ |        | Search the DriveWealth API documentation for endpoint details, request/response shapes, required parameters, and field descriptions. |
