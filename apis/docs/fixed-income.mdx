...
```mdx
<TutorialTile backgroundColor="#ffffff" emoji="📈" id="689398a4a6b0feee60a4a799" link="https://developer.drivewealth.com/v1.60.0/recipes/invest-in-fixed-income" slug="invest-in-fixed-income" title="Invest in fixed income" />
```
...
### Basic attributes of a fixed income instrument
...
### Buying a fixed income instrument
...
### Owning a fixed income instrument
