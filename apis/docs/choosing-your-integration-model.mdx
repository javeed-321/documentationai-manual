---
title: "Choosing your integration model"
---
...
- [Depositing](https://developer.drivewealth.com/apis/docs/depositing-1)
- [Withdrawing](https://developer.drivewealth.com/apis/docs/withdrawing-1)
- [Using Plaid](https://developer.drivewealth.com/apis/docs/using-plaid)
...
❗️ Travel Rule compliance is required for every bulk deposit and withdrawal. You must create a Bank Account object with `bankAccountPurpose: "TRAVEL_RULE"` and pass the resulting `bankAccountID` with each transaction. See [Travel Rule](https://developer.drivewealth.com/apis/docs/travel-rule).
...
- [Bulk Funding](https://developer.drivewealth.com/apis/docs/bulk-funding)
- [Travel Rule](https://developer.drivewealth.com/apis/docs/travel-rule)
...
❗️ Travel Rule compliance is required. Unlike bulk funding, the Bank Account object must be created _before_ creating the brokerage account. API sequencing is: Create User → Create Bank Account (with `bankAccountPurpose: "TRAVEL_RULE"`) → Create Account. See [Travel Rule](https://developer.drivewealth.com/apis/docs/travel-rule).
...
- [Cashless Settlement](https://developer.drivewealth.com/apis/docs/bulk-fundingcashless)
- [Travel Rule](https://developer.drivewealth.com/apis/docs/travel-rule)
...
2. **Cashless reconciliation** — instead of pre-funding, you settle trades on a T+1 basis. See [Cashless Settlement](https://developer.drivewealth.com/apis/docs/bulk-fundingcashless) for details.
...
- [Omnibus Trading](https://developer.drivewealth.com/apis/docs/omnibus-trading)
- [Cashless Settlement](https://developer.drivewealth.com/apis/docs/bulk-fundingcashless)
