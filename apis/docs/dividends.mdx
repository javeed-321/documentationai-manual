...
DriveWealth’s service has been enhanced to now provide that dividends are paid to the customer on the day of the dividend payment date. When a dividend is processed, it is received in bulk, and correspondingly booked to the customer’s Account through a Transaction.
