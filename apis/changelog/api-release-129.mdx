...
Added new endpoint `GET https://bo-api.drivewealth.io/back-office/funding/deposits/suspense`. See \[Get Suspense Payment API] ([https://developer.drivewealth.com/reference/get-suspense-payment](https://developer.drivewealth.com/reference/get-suspense-payment)). Permissions required to utilize this endpoint.
