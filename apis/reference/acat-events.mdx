...
<CodeGroup tabs="Created [ACATs],Created [teen]">
  ```json title="Created [ACATs]"
  {
...
<CodeGroup tabs="Updated [ACAT],Updated [Teen]">
  ```json title="Updated [ACAT]"
  {
...
<CodeGroup tabs="Completed [ACATs Successful],Completed [ACATs Failed],Completed [Teen]">
  ```json title="Completed [ACATs Successful]"
  {
      "id": "event_89394394-6d25-404a-8388-f1ee6a969d12",
  ...
  ```json title="Completed [ACATs Failed]"
  {
