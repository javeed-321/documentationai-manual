...
#### Compliance AML Info - Funding Sources

Used by `fundingSources` within the `COMPLIANCE_AML_INFO` document to indicate a user's sources of funds.

| ENUM       | Definition             |
| :--------- | :--------------------- |
| EMP        | Employment income.     |
| GIFT       | Gift.                  |
| TRUST      | Trust.                 |
...
#### Compliance AML Info - Transfer Total Expected Range

Returned in `transferTotalExpectedRange` within the `COMPLIANCE_AML_INFO` document as a range mapping for the expected total transfer amount. This is a response-only, server-computed field.

| ENUM          | Definition          |
| :------------ | :------------------ |
| $0\_9999      | $0 - $9,999         |
| $10K\_49999   | $10,000 - $49,999   |
| $50K\_99999   | $50,000 - $99,999   |
| $100K\_249999 | $100,000 - $249,999 |
| $250K\_499999 | $250,000 - $499,999 |
| $500K\_       | $500,000+           |
