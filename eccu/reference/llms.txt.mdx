...
- [List permissions](https://techdocs.akamai.com/eccu/reference/get-permissions.md): Returns the ECCU permissions. If the response's `submitEccuRequest` member is enabled, you can run the [Create an ECCU request](/reference/post-request) operation to invalidate content.
